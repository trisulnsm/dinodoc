...
After identifying significant multidimensional relationships, continue the investigation in [**Explore Flows**](/docs/guide/ug/tools/explore_flows) using the network entities revealed by the correlation.
