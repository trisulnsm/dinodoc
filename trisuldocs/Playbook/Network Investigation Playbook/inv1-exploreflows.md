...
Open [**Explore Flows**](/docs/guide/ug/tools/explore_flows) and enter the IP address being investigated.
...
Remain within [**Explore Flows**](/docs/guide/ug/tools/explore_flows) and review the [**Top Conversations**](/docs/guide/ug/tools/explore_flows#top-conversations) view for the selected IP address.
...
After identifying the host's communication patterns, remain within [**Explore Flows**](/docs/guide/ug/tools/explore_flows) and drill down from the [**Top Conversations**](/docs/guide/ug/tools/explore_flows#top-conversations) view into the [**Top Matching Flows**](/docs/guide/ug/tools/explore_flows#top-matching-flows) view. This is a natural continuation of the communication investigation and allows you to determine which specific sessions explain the observed behavior.
...
Remain within [**Explore Flows**](/docs/guide/ug/tools/explore_flows) and select the [**Top Applications**](/docs/guide/ug/tools/explore_flows#activity-details) topper under the activity details to open the Application Usage view for the selected host.
...
Rather than introducing new data, [**Aggregate Flows**](/docs/guide/ug/tools/aggregate_flows) presents the same flow information from different perspectives, allowing you to view traffic by IP address, port, router, application, and other network dimensions.
