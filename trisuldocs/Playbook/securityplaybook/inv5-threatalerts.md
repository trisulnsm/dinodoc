...
From the selected host or network entity, click the **Actions** menu and choose [**Host Conversations**](/docs/guide/ug/tools/explore_flows#top-conversations) to investigate the associated communication.
...
Continue the investigation using [**Historical Investigation (Retro)**](/docs/guide/ug/cg/retro), [**DNS Analysis**](/docs/prodguide/nsm/Resources/dns), and [**Packet Analysis**](/docs/prodguide/nsm/Resources/dns#option-button).
