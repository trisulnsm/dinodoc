...
Continue the investigation using [**Historical Investigation (Retro)**](/docs/guide/ug/cg/retro), [**DNS Analysis**](/docs/guide/ug/resources/dns), and [**Packet Analysis**](/docs/guide/ug/resources/dns#option-button).
