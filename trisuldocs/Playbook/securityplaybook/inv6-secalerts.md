...
Review the communication associated with the alert using [**Host Conversations**](/docs/guide/ug/tools/explore_flows#top-conversations), [**Flow Details**](/docs/guide/ug/tools/explore_flows#top-matching-flows), and [**Packet Analysis**](/docs/guide/ug/tools/explore_flows#flow-options) where available.
...
Continue the investigation using [**Host Conversations and Flow Details**](/docs/guide/ug/tools/explore_flows#top-matching-flows) for the affected hosts.
...
Open [**MITRE ATT&CK Mapping**](/docs/guide/ug/alerts/mitre).
