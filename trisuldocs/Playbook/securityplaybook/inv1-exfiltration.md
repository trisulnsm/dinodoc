...
In [**Trisul Retro**](/docs/documentation/ug/cg/retro#selecting-a-time-window), navigate to:
...
The [**Transmit**](/docs/documentation/ug/cg/retrotools#investigate-ip-activity) view lists hosts ranked by the volume of outbound traffic during the selected investigation period, making it easy to identify systems responsible for significant data transfers.
...
From the [**Transmit**](/docs/documentation/ug/cg/retrotools#investigate-ip-activity) view, click the **Actions** menu for the selected host and choose **Host Conversations**.
...
From the [**Host Conversations**](/docs/documentation/ug/tools/explore_flows#top-conversations) view, click the [**Actions**](/docs/documentation/ug/tools/explore_flows#flow-options) menu for the selected conversation and choose **Flow Details**.

The [**Flow Details**](/docs/documentation/ug/tools/explore_flows#top-matching-flows) view provides detailed information about the communication, including the source and destination addresses, ports, protocols, applications, timestamps, and the volume of data transferred.
...
From the [**Flow Details**](/docs/documentation/ug/tools/explore_flows#top-matching-flows) view, click the [**Actions**](/docs/documentation/ug/tools/explore_flows#flow-options) menu for the selected flow and choose **Download PCAP**.
...
Open [**Historical Investigation (Retro)**](/docs/documentation/ug/cg/retro/) for the affected host and destination.
