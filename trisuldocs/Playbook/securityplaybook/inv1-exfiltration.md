...
In [**Trisul Retro**](/docs/guide/ug/cg/retro#selecting-a-time-window), navigate to:
...
The [**Transmit**](/docs/guide/ug/cg/retrotools#investigate-ip-activity) view lists hosts ranked by the volume of outbound traffic during the selected investigation period, making it easy to identify systems responsible for significant data transfers.
...
From the [**Host Conversations**](/docs/guide/ug/tools/explore_flows#top-conversations) view, click the [**Actions**](/docs/guide/ug/tools/explore_flows#flow-options) menu for the selected conversation and choose **Flow Details**.

The [**Flow Details**](/docs/guide/ug/tools/explore_flows#top-matching-flows) view provides detailed information about the communication, including the source and destination addresses, ports, protocols, applications, timestamps, and the volume of data transferred.
...
From the [**Flow Details**](/docs/guide/ug/tools/explore_flows#top-matching-flows) view, click the [**Actions**](/docs/guide/ug/tools/explore_flows#flow-options) menu for the selected flow and choose **Download PCAP**.
