...
sure you have followed the steps in [Switching to a distributed domain](/docs/ug/domain/change_domain#switching_to_a_distributed_domain) from the default single machine domain.
