h1. Setup packet captures for Trisul 
...
h3. Virtual Machine configuration
...
h2. Configuring port mirror / SPAN Port
...
h3. Bridging Ethrenet Connections
...
<div class='tabs tabs-text'>
  <ul class='nav nav-tabs'>
    <li class='active'>
      <a href="#tab_brctl_ubuntu" data-toggle="tab">
        <img src="/images/icons/ubuntu.png"></img>
        Ubuntu
      </a>
    </li>
    <li>
      <a href="#tab_brctl_centos" data-toggle="tab">
        <img src="/images/icons/centos.png"></img>
        CentOS
      </a>
    </li>
  </ul>
  <div class='tab-content'>
    <div id='tab_brctl_ubuntu' class='tab-pane fade in active'>

      Install the bridge-utils package.

      <pre>sudo apt-get install bridge-utils</pre>

      Automatically Create the Bridge at Start-up<br/>
    ...
    <div id='tab_brctl_centos' class='tab-pane fade in'>
     ...
     sample @/etc/sysconfig/network-scripts/ifcfg-eth1@
      ...
      Restart networking
      <pre> /etc/init.d/netwok restart</pre>
    </div>
  </div>
</div>
