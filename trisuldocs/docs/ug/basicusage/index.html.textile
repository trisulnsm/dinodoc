...
<a data-toggle="collapse" data-target="#starterror">Getting an error here?</a>

<div id="starterror" class="collapse text-danger">
The error message is usually displayed right below. The most common reasons are 

* incorrect network adapter : By default @trisul-probe@ listens for traffic on @eth0@ If you do not have an @eth0@ on the box the you need to switch the network adapter to the correct one using the steps in "Configuring packet capture adapters":/docs/ug/webadmin/profiles.html
