...
| [Counter Group toppers](/docs/ug/cg/retrotools#counter-group-toppers)                                 | Who were the toppers in a counter group for a statistic ? Also shows topper trends in time interval with ability to do a [cross drill](/docs/ug/cg/retrotools#cross_drill) on any of them                 |
