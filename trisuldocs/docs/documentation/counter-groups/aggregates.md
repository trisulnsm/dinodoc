...
|DIR_INTOHOME, DIR_OUTOFHOME, DIR_TRANSIT, DIR_WITHINHOME | Traffic relative to the home network as defined in [Home Networks](/docs/documentation/ag/context/home_networks) These represent traffic entering the home network , exiting the home network, totally outside the home network and within the home network. |
...
Active sessions. Also can use [Meta Session Group > Master Size ](/docs/documentation/counter-groups/meta-session-group#master-size)
...
See [cardinality counters](/docs/documentation/ag/context/cardinality_countergroups)