...
|     | Module Templates                                                          |
| --- | ------------------------------------------------------------------------- |
| 1   | [Key Traffic](/docs/documentation/ug/ui/module_templates#key-traffic)                   |
| 2   | [Toppers Traffic](/docs/documentation/ug/ui/module_templates#toppers-traffic)           |
| 3   | [Toppers Trend](/docs/documentation/ug/ui/module_templates#toppers-traffic)             |
| 4   | [Current Toppers](/docs/documentation/ug/ui/module_templates#current-toppers)           |
| 5   | [Retro Toppers](/docs/documentation/ug/ui/module_templates#retro-toppers)               |
| 6   | [Single Value](/docs/documentation/ug/ui/module_templates#single-value)                 |
| 7   | [Real Time Traffic](/docs/documentation/ug/ui/module_templates#real-time-traffic)       |
| 8   | [Real Time Single](/docs/documentation/ug/ui/module_templates#real-time-single)         |
| 9   | [Real Time Toppers](/docs/documentation/ug/ui/module_templates#real-time-toppers)       |
| 10  | [Favorite Key Traffic](/docs/documentation/ug/ui/module_templates#favorite-key-traffic) |
| 11  | [Traffic Chart](/docs/documentation/ug/ui/module_templates#traffic-chart)               |
| 12  | [Alert List](/docs/documentation/ug/ui/module_templates#alert-list)                     |
| 13  | [Alert Count](/docs/documentation/ug/ui/module_templates#alert-count)                   |
| 14  | [Existing Modules](/docs/documentation/ug/ui/module_templates#existing-modules)         |
| 15  | [Custom URL Page](/docs/documentation/ug/ui/module_templates#custom-url-page)           |
| 16  | [Crosskey Tree](/docs/documentation/ug/ui/module_templates#crosskey-tree)               |
| 17  | [Crosskey Sankey](/docs/documentation/ug/ui/module_templates#crosskey-sankey)       
...
| Expression     | -             | Use an [arithmetic expression](/docs/documentation/ug/ui/modules#creating-modules-with-arithmetic-expressions) to customize the data shown by the module.    |
...
| Enable Range Slider            | -             | Enables a [range slider](/docs/documentation/ug/ui/charts#range-slider), so users can select a specific portion of the displayed time range.                                            |
| Mark PCAP Availability         | -             | Displays [availability of PCAP (Packet Capture) data](/docs/documentation/ug/ui/charts#pcap-availability), on the chart when packet capture data is available.                        |
| Show Retro Tabs/ Time Selector | -             | Toggle to display or hide [retro tabs](/docs/documentation/ug/ui/charts#retro-tabs) and [time selector](/docs/documentation/ug/ui/elements#time-selector), allowing users to navigate through historical data                                                                                                  | 
