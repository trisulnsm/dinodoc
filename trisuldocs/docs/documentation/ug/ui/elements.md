...
The search box is located on the right side of the [Top Panel](/docs/documentation/ug/ui/userlayout#top-panel-details) as shown here.
...
> flexible. See [URL Resources](/docs/documentation/ug/resources/url) and [DNS Resources](/docs/documentation/ug/resources/dns)
...
You can click on any key items on the chart and it will take you to the [Key dashboard](/docs/documentation/ug/ui/key_dashboard) of that Key.
...
On tables featuring a [*Download PCAP*](/docs/documentation/ug/caps/methods#download-pcap) button, clicking on the button
