...
- **Hover**: Display additional information or context on [Tooltips](/docs/documentation/ug/ui/charts#tooltip) when hovering over a data point  
...
1) [Ellipsis Menu](/docs/documentation/ug/ui/charts#ellipsis-menu)
2) [Chart Interaction Control Icons](/docs/documentation/ug/ui/charts#chart-interaction-controls)
3) [Tool Tip](/docs/documentation/ug/ui/charts#tooltip) 
4) [Legend Table](/docs/documentation/ug/ui/charts#legend-table)
...
1) Click on the [*ellipsis menu*](/docs/documentation/ug/ui/charts#ellipsis-menu) from any chart and click *View historical* to view the retro chart of that particular module

![](images/retrochart2.png)

*Figure: View Historical Option from Module Toolbar*

2) Select a [time frame](/docs/documentation/ug/ui/elements#time-selector) and view the retro chart for that particular past time period.
...
The time-based tabs include:
  ...
  **Custom** Tab: Redirects users to the [Time Selector](/docs/documentation/ug/ui/elements#time-selector), allowing for flexible, user-defined time ranges and custom data segmentation.
