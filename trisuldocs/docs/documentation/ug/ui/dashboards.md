...
- **[Data Volume](/docs/documentation/learntrisul/terminology#data-volume)** refers to the total amount of data transferred during the selected time period.
- **[Bandwidth](/docs/documentation/learntrisul/terminology#bandwidth)** refers to the rate at which data is being transferred, usually displayed in Kbps or Mbps.
- **[In](/docs/documentation/learntrisul/terminology#in)** refers to the amount of data received by the network during the selected time period.
- **[Out](/docs/documentation/learntrisul/terminology#out)** refers to the amount of data sent from the network during the selected time period.
- **[Active Flows](/docs/documentation/learntrisul/terminology#active-flows)** refers to the number of network flows that are currently active.
- **[Active Internal IPs](/docs/documentation/learntrisul/terminology#active-internal-ips)** refers to the number of internal IP addresses that are currently active.
- **[Top Hosts](/docs/documentation/learntrisul/terminology#top-hosts)** refers to hosts associated with the highest traffic rates.
- **[Top Apps](/docs/documentation/learntrisul/terminology#top-apps)** refers to applications associated with the highest traffic rates.
- **[Blacklist](/docs/documentation/learntrisul/terminology#blacklist)** refers to alerts associated with blacklisted activity.
- **[IDS Alerts](/docs/documentation/learntrisul/terminology#ids-alert)** refers to the Intrusion Detection System and, in this dashboard, the number of alerts generated by it.
...
- [**Alert**](/docs/documentation/learntrisul/terminology#alert) — A notification generated when a security rule or condition is triggered.
- [**IDS Alert**](/docs/documentation/learntrisul/terminology#ids-alert) — An alert generated by an Intrusion Detection System when network traffic matches a known suspicious or malicious activity pattern.
- [**Signature**](/docs/documentation/learntrisul/terminology#signature) — A rule used by an IDS to identify a particular type of suspicious network activity.
- [**Classification**](/docs/documentation/learntrisul/terminology#classification) — The category assigned to an IDS alert to describe the type of activity detected.
- [**Source IP**](/docs/documentation/learntrisul/terminology#source-ip) — The IP address from which the traffic or security event originated.
- [**Destination IP**](/docs/documentation/learntrisul/terminology#destination-ip) — The IP address to which the traffic or security event was directed.
- [**Bandwidth**](/docs/documentation/learntrisul/terminology#bandwidth) — The amount of network traffic transferred over a period of time.
- [**Topper / Top-N**](/docs/documentation/learntrisul/terminology#topper-top-n) — A ranking that shows the highest-volume or highest-activity items for the selected metric.
...
- **[Flow](/docs/documentation/learntrisul/terminology#flow)** refers to a network communication between endpoints. A flow can represent communication such as a device accessing a website or server.
- **[IP Flow](/docs/documentation/learntrisul/terminology#ip-flow)** refers to a flow identified at the IP layer between communicating endpoints.
- **[Long-Lived Flow](/docs/documentation/learntrisul/terminology#long-lived-flow)** refers to a network flow that has remained active for a long period of time, regardless of how much data it has transferred.
- **[TCP Payload](/docs/documentation/learntrisul/terminology#tcp-payload)** refers to the actual data carried by a TCP connection, excluding the additional information used by TCP to transport that data.
- **[Upload](/docs/documentation/learntrisul/terminology#upload)** refers to data being transferred out of your network to an external destination.
- **[Download](/docs/documentation/learntrisul/terminology#download)** refers to data being transferred into your network from an external destination.
- **[Inbound Traffic](/docs/documentation/learntrisul/terminology#inbound--outbound--transit-traffic)** refers to traffic coming into your home network.
- **[Outbound Traffic](/docs/documentation/learntrisul/terminology#inbound--outbound--transit-traffic)** refers to traffic leaving your home network.
...
- **[IDS (Intrusion Detection System)](/docs/documentation/learntrisul/terminology#ids-alert)** is a system that examines network activity and generates alerts when it detects activity matching configured detection rules.
- **[IDS Alert](/docs/documentation/learntrisul/terminology#ids-alert)** is an alert generated by the intrusion detection system when network activity matches a detected security event or rule.
- **[Signature](/docs/documentation/learntrisul/terminology#signature)** identifies the particular type of activity or detection rule associated with an IDS alert.
- **[Priority](/docs/documentation/learntrisul/terminology#priority)** indicates the priority assigned to an IDS alert.
- **[Classification](/docs/documentation/learntrisul/terminology#classification)** describes the category assigned to an IDS alert.
- **[Source IP](/docs/documentation/learntrisul/terminology#source-ip)** identifies the IP address from which the alerted network activity originated.
- **[Destination IP](/docs/documentation/learntrisul/terminology#destination-ip)** identifies the IP address receiving the alerted network activity.
- **[Pivot](/docs/documentation/learntrisul/terminology#pivot)** determines which field is used to group or examine the alert activity, such as Signature, Priority, Classification, Source IP, Destination IP, or Port.
- **[Raw Alert](/docs/documentation/learntrisul/terminology#raw-alert)** refers to an individual IDS alert as it is received.
- **[Aggregated Alert](/docs/documentation/learntrisul/terminology#aggregated-alert)** refers to IDS alerts grouped together to provide a summarized view of alert activity.
- **[Real Time Stabber](/docs/documentation/learntrisul/terminology#stabber)** is a Trisul feature that allows events to be pushed directly from the Trisul Probe to the browser in real time.
...
- **[Inbound Traffic](/docs/documentation/learntrisul/terminology#inbound--outbound--transit-traffic)** refers to traffic coming into your home network.
- **[Outbound Traffic](/docs/documentation/learntrisul/terminology#inbound--outbound--transit-traffic)** refers to traffic leaving your home network.
- **[Bandwidth](/docs/documentation/learntrisul/terminology#bandwidth)** is the rate at which data is being transferred, usually expressed in units such as Kbps or Mbps.
- **[Real Time](/docs/documentation/learntrisul/terminology#real-time)** means that the dashboard receives and displays current network activity as it occurs rather than relying on periodic historical updates.
- **[Real Time Stabber](/docs/documentation/learntrisul/terminology#stabber)** is a Trisul feature that allows the Trisul Probe to push events directly to the browser in real time.
...
- **[Counter Group](/docs/documentation/learntrisul/terminology#counter-group)** is a category of information that Trisul tracks, such as Hosts, Applications, Countries, or ASNs.
- **[Key](/docs/documentation/learntrisul/terminology#key)** is an individual value being tracked within a Counter Group. For example, an individual IP address can be a key in the Hosts Counter Group.
- **[Hi Water](/docs/documentation/learntrisul/terminology#hi-water)** is the configured upper threshold for a monitored value.
- **[Low Water](/docs/documentation/learntrisul/terminology#low-water)** is the configured lower threshold for a monitored value.
...
- **[Alert](/docs/documentation/learntrisul/terminology#alert)** is a recorded event generated when a configured detection condition is met.
- **[Threshold Crossing Alert](/docs/documentation/learntrisul/terminology#threshold-crossing-alert)** is generated when a monitored value crosses a configured threshold.
- **[Flow Tracker Alert](/docs/documentation/learntrisul/terminology#flow-tracker-alert)** is generated when a network flow matches the conditions configured in a flow tracker.
- **[IDS Alert](/docs/documentation/learntrisul/terminology#ids-alert)** is an alert generated by an external Intrusion Detection System and ingested by Trisul.
- **[Blacklist](/docs/documentation/learntrisul/terminology#blacklist)** refers to alerts associated with activity involving known blacklisted or suspicious entities.
- **[Priority](/docs/documentation/learntrisul/terminology#priority)** indicates the priority assigned to an IDS alert.
- **[Probe](/docs/documentation/learntrisul/terminology#probe)** is the Trisul component that receives and analyzes network traffic.
...
- **[Bandwidth](/docs/documentation/learntrisul/terminology#bandwidth)** is the rate at which data is being transferred across the network.
- **[CPU Usage](/docs/documentation/learntrisul/terminology#cpu-usage)** shows how much of the system's processing capacity is being used by the operating system and Trisul Probe.
- **[Memory Usage](/docs/documentation/learntrisul/terminology#memory-usage)** shows how much system memory is being used by the operating system and Trisul Probe.
- **[Packet](/docs/documentation/learntrisul/terminology#packet)** is a unit of network data transmitted across the network.
- **[Dropped Packet](/docs/documentation/learntrisul/terminology#dropped-packet)** is a packet that was not successfully processed by the packet capture or processing pipeline.
- **[Packets Wire](/docs/documentation/learntrisul/terminology#packets-wire)** is the number of packets seen per minute by the packet capture mechanism.
- **[Flush Time](/docs/documentation/learntrisul/terminology#flush-time)** is the time Trisul takes to obtain a streaming snapshot of the latest time window and flush the data to Trisul-Hub.
- **[IOP (Input/Output Operation)](/docs/documentation/learntrisul/terminology#iop-inputoutput-operation)** is a read or write operation performed on a storage device.
- **[PCAP (Packet Capture)](/docs/documentation/learntrisul/terminology#pcap-packet-capture)** refers to captured raw network packets that can be stored for later analysis.
- **[PCAP Disk Bandwidth](/docs/documentation/learntrisul/terminology#pcap-disk-bandwidth)** is the rate at which raw packet capture data is written to disk.
- **[Front End](/docs/documentation/learntrisul/terminology#front-end)** refers to the streaming pipeline or engine through which network packets are received and processed.
