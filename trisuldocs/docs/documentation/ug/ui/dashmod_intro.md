...
For information about the dashboards that Trisul provides by default, see **[Default Dashboards](/docs/documentation/ug/ui/dashboards)**.

For information about creating and customizing dashboards, see **[Dashboards](/docs/documentation/ug/ui/create_dashboards#create-a-dashboard)**.
...
For information about creating and managing modules, see **[Modules](/docs/documentation/ug/ui/modules)**.
...
For details about arranging modules and changing dashboard layouts, see **[Dashboards](/docs/documentation/ug/ui/create_dashboards)**.
...
For the current list of default dashboards and the modules they contain, see **[Default Dashboards](/docs/documentation/ug/ui/dashboards)**.
...
For dashboard creation, editing, layout management, and other dashboard operations, see **[Dashboards](/docs/documentation/ug/ui/create_dashboards#dashboard-menu-options)**.
...
For creating, editing, cloning, deleting, and configuring modules, see **[Modules](/docs/documentation/ug/ui/modules)**.
...
- See **[Dashboards](/docs/documentation/ug/ui/create_dashboards)** for dashboard creation and customization.
- See **[Modules](/docs/documentation/ug/ui/modules)** for module creation and configuration.
...
- **[User Layout](/docs/documentation/ug/ui/userlayout)** - Understand the main areas of the Trisul User UI.
- **[Dashboards](/docs/documentation/ug/ui/create_dashboards)** - Create, customize, manage, and import dashboards.
- **[Modules](/docs/documentation/ug/ui/modules)** - Create and manage dashboard modules.
- **[Default Dashboards](/docs/documentation/ug/ui/dashboards)** - Explore the dashboards provided with Trisul.
- **[Module Templates](/docs/documentation/ug/ui/module_templates)** - Understand the templates used to create modules.
