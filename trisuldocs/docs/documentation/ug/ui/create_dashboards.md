...
> **Before you begin:** If you are new to Trisul dashboards and modules, see [Introduction to Dashboards and Modules](/docs/documentation/ug/ui/dashmod_intro) to understand how dashboards and modules work together.
...
5) #### Chart Interaction
    ...
    For details about the chart interactions in a module, see [Charts](/docs/documentation/ug/ui/charts).
...
To edit a Dashboard, from the list of dashboards go to the dashboard you would like to edit. And click on the [Dashboard Menu](/docs/documentation/ug/ui/create_dashboards#dashboard-menu-options) button, the **ellipsis icon** on the top right corner of the dashboard and click **Customize**.
