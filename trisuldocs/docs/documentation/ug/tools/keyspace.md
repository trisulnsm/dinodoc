...
:::
The following *Search criteria* form opens up with the [*Hide/ Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) option.
...
| [Time Frame](/docs/documentation/ug/ui/elements#time-selector)   | Defines the time period of retrieval							|
| Max items 					               	     | Limits the number of results returned 						|
| [Key Space](/docs/documentation/ug/tools/keyspace#key-space-list)| Specifies the search scope such as IP address ranges  	    |
...
- [**Download**](/docs/documentation/ug/ui/elements#download-button)  
You can the download the result in three easy formats by clicking on the *Download* button at the upper right hand side.
- [**Toggle Labels**](/docs/documentation/ug/ui/elements#toggle-labels)  
...
**[Traffic Chart](/docs/documentation/ug/cg/retrotools#show-traffic-chart-for-an-item)**  
...
**[Explore Flows](/docs/documentation/ug/tools/explore_flows)**   
...
**[Key Details](/docs/documentation/ug/ui/key_dashboard)**   
