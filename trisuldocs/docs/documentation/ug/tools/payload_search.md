...
> Make sure you have full packet capture and flow tracking enabled in the [trisulConfig.xml](/docs/documentation/ref/trisulconfig) file
...
Each column in the search result table are [*Column Sortable*](/docs/documentation/ug/ui/elements#column-sorter), enabling flexible data analysis and visualization.
...
Users can then select the [**Download PCAP**](/docs/documentation/ug/ui/elements#download-pcap-button) option to retrieve the associated packet capture file for further detailed examination using specialized tools and offline investigation.
