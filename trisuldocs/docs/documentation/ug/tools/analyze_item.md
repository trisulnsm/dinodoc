...
The following *search criteria* window opens up with a [*Hide/ Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) option.
...
| [Time Frame](/docs/documentation/ug/ui/elements#time-selector)    | Define the time range for the chart                         |
...
> You can set the number of days for which you want to see the data as individual charts in [WebTrisul Options &rarr; Charts &rarr; Long Term Chart Day Limit](/docs/documentation/ag/webadmin/web_options#chart). 

Using the [legend table](/docs/documentation/ug/ui/charts#legend-table) and [Chart Interaction Controls](//docs/documentation/ug/ui/charts#chart-interaction-controls), you can drill down into the intra-day data, facilitating a more detailed temporal analysis and exploration of the search result.
