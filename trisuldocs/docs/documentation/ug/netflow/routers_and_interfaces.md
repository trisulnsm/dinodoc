...
1. [Time Selector](/docs/documentation/ug/ui/elements#time-selector)
...
- [Column Selector](/docs/documentation/ug/ui/elements#column-selector)
- [Download Options](/docs/documentation/ug/ui/elements#download-button)
- Filter Routers
...
With *[Key dashboard](/docs/documentation/ug/ui/key_dashboard)*, access a centralized dashboard displaying essential metrics and information for each router, providing a quick overview of its performance and status.
...
- [Column Selector](/docs/documentation/ug/ui/elements#column-selector)
- [Download Options](/docs/documentation/ug/ui/elements#download-button)
- [Filter Interfaces](/docs/documentation/ug/netflow/routers_and_interfaces#filtering-routers)
...
| ----------------------- | ------------------------------------- | --------------------------------------------- |
| [Drilldown](/docs/documentation/ug/netflow/drilldown)               | Interface drilldown                   | The most common options like What are the Top apps, hosts, conversations, and raw flows on the interface. If you have *Interface Tracking* enabled you get perfect accuracy even for long term (weeks) analysis                                        |
...
| [Key Dashboard](/docs/documentation/ug/ui/key_dashboard)           | Interface key dashboard               | To see interface metrics, assign name, jump to flows, and traffic analysis at interface level                                                                                                                                                          |
| [Long term traffic chart](/docs/documentation/ug/tools/analyze_item) | Long term charts                      | Default 7 day view of interface IN/OUT traffic - 1 chart per day                                                                                                                                                                                       |
...
| [Live SNMP](/docs/documentation/ug/netflow/snmp#live-snmp)                    | Charts            | Use SNMP to show a 10-sec view of Recv and Xmit traffic on the interface                                        |
...
| [Explore Flows](/docs/documentation/ug/tools/explore_flows)           | Explore Network Flows                 | Provides detailed activity of each and every flow in and out of that interface                                                                                                                                                                         |
| [Aggregated Flows](/docs/documentation/ug/tools/aggregate_flows)        | Aggregate Network Flows               | Provides all matching flows and show aggregated volumes by hosts, ports, protocols from that interface                      |
