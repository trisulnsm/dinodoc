...
:::info navigation
:point_right: Go to Context: Default &rarr;profile0 &rarr; [NetFlow Wizard](/docs/documentation/ug/netflow/netflow_wizard)
:::
...
- Adjust the sampling rate. If some of your devices uses *flow sampling*
  ...
  Sampling Rate mapping](/docs/documentation/ref/netflow-config#sampling-rates)
...
Use the [NetFlow Wizard](/docs/documentation/ug/netflow/netflow_wizard) to
...
You can tweak the [NetFlow configuration file](/docs/documentation/ref/netflow-config) for more advanced settings.
