...
Tool*](/docs/documentation/ug/netflow/routers_and_interfaces#interfaces-table). The options in Interface Drilldown tool looks slightly different on each interface depending on if [*Interface Tracking*](/docs/documentation/ug/netflow/interface_tracker) is enabled on the interface or not.
...
Interfaces Tool](/docs/documentation/ug/netflow/routers_and_interfaces)
:::
...
Click the **Show Search Form** on the [top right](/docs/documentation/ug/ui/elements#hide-show-search-form) to open up a form where you can control the following.
...
Counter Group](/docs/documentation/ag/context/crosskey_countergroups) with Flow-Interfaces as the first group, then the second group will be shown as a Tab.
...
[Interface Tracker](/docs/documentation/ug/netflow/interface_tracker) .
...
enabling [Interface Tracker](/docs/documentation/ug/netflow/interface_tracker) .
...
sending or receiving traffic from the subject interface. This is only available after enabling [Cross Key](/docs/documentation/ag/context/crosskey_countergroups) ![](images/interface_matrix_light.png)

*Figure: Interface Traffic Matrix*

## ASN, NBAR, and Other Details

These are available in the interface drilldowns if the proper trackers are created ahead of time when [Cross Key](/docs/documentation/ag/context/crosskey_countergroups) is enabled for them.
