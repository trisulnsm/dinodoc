...
| [Interface Matrix](/docs/documentation/ug/netflow/drilldown#interface-traffic-matrix--chord-diagram) | Displays traffic flows between interfaces.                                                                                          |
...
- First configure SNMP v2 or v3 parameters for the device using the aforementioned [*Configuring SNMP*](/docs/documentation/ug/netflow/snmp#configuring-snmp) steps .
...
From the list of [Interface drilldown options](/docs/documentation/ug/netflow/routers_and_interfaces#drilldown-from-the-interfaces-table), you can select the following options to view SNMP traffic charts. 
