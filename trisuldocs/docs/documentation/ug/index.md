...
If you are new to Trisul, follow this documentation path [*System Requirements*](/docs/documentation/starthere/setuptrisul/install/requirements)  &rarr; [*Installation*](/docs/documentation/ag/install/doinstall) &rarr;  [*Basic Usage*](/docs/documentation/ag/basictasks/) . 
:::
...
- [:memo: Trisul Reference](/docs/documentation/ref)
  - Configuration files, command line programs, helper  scripts 
- [:memo: Howtos](/docs/documentation/howto)
