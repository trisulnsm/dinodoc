...
performance troubleshooting. For example, you can pull up ARP/Spanning Tree packets which can help you nail a layer 2 issue. [Packet Capture Basics](/docs/documentation/ug/caps/fullcontent) describes the design of in greater detail.
...
- I dont want to store SYSLOG packets because I send them to splunk  
  [View all tasks](/docs/documentation/ug/caps/tasks)
