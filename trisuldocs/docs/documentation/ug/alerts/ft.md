...
- [Web Interface Alert Tracker](/docs/documentation/ug/ui/userlayout#alerts-and-notifications) (located in the top-right corner)
- Email notifications
...
- Click on the [*Download* button](/docs/documentation/ug/ui/elements#download-button) to download the *Flow Tracker Alerts* data in PDF, XLSX, and CSV formats.
- You can also search for *Flow Tracker Alerts* at any time interval. Clicking on the [*Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) option on the top right will show you the [Time Frame](/docs/documentation/ug/ui/elements#time-selector) to customize alerts for specific dates.
...
- You can click on each IP and Port to drilldown for further analysis which will take you to the [*Key Dashboard*](/docs/documentation/ug/ui/key_dashboard) and each column has a [*Column Sorter*](/docs/documentation/ug/ui/elements#column-sorter) clicking on it will sort the data in the column.
 
- You can also [*Download*](/docs/documentation/ug/ui/elements#download-button) the *Flow Tracker Alerts* data from here in PDF, XLSX, and CSV formats.


## Sending Alerts by Email

You can set up email alert delivery for flow trackers as described in the section [Alerts via Email](/docs/documentation/ug/alerts/email_wizard)
