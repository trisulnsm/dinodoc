...
2. **Temporal Baseline Configuration**: Computation is [*Day of week based*](/docs/documentation/ug/alerts/tband#day-of-week-based) ensuring weekends are tracked separately for recognizing distinct usage patterns
...
:::info navigation
:point_right: Click on any *key* in a chart&rarr; From [Key Dashboard](/docs/documentation/ug/ui/key_dashboard)&rarr; Create Threshold Band
:::
...
| [View Training Data](/docs/documentation/ug/alerts/tband#view-training-data)   | Select one from the drop down menu to view training data separately for each day (sun, mon, tue, wed, thu, fri, sat)                                                                                    |
| [Option Button](/docs/documentation/ug/alerts/tband#option-button)        | By clicking on the option button you can choose to view alerts, edit, and delete        |
...
- Additionally, the chart supports [interactive drill-down capabilities](/docs/documentation/ug/ui/charts#chart-interaction-controls), allowing users to zoom in on specific segments, enabling high-resolution visualization of sudden drops and spikes in the data.  
- Click on the *Retro Dashboard* button to further analyze using *Retro Counters* and *Retro Tools*.  
- By clicking on the *Key Dashboard* button, you can navigate to the [*Key Dashboard*](/docs/documentation/ug/ui/key_dashboard) of the *key* associated with the Threshold Band Anomaly alerting.
