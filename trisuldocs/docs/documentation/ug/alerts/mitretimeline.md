...
The **Explore Session Flows** option opens [**Explore Flows**](/docs/documentation/ug/tools/explore_flows) with the selected source IP and destination IP already populated, allowing analysts to continue investigating the corresponding network communication.
...
10. Continue traffic investigation using [**Explore Flows**](/docs/documentation/ug/tools/explore_flows).
