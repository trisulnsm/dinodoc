...
See [Trisul Badfellas](/docs/documentation/ag/install/badfellas)
...
| Drilldown Button | Click on the Drilldown button to view the [edge graph](/docs/documentation/ug/edges/) of the Signature ID, and to delete that alert                                                                                          |
...
- Interactive functionalities of the table include : [*Column Sorter*](/docs/documentation/ug/ui/elements#column-sorter), [*Download Button*](/docs/documentation/ug/ui/elements#download-button), [*Show/Hide Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form)

### Show Search Form

The [*Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) enables you to search and filter alerts based on certain criteria to narrow down alert volumes.
...
Interactive functionalities of the table include : [*Column Sorter*](/docs/documentation/ug/ui/elements#column-sorter), [*Toggle Labels*](/docs/documentation/ug/ui/elements#toggle-labels), [*Download Button*](/docs/documentation/ug/ui/elements#download-button), [*Download PCAP*](/docs/documentation/ug/ui/elements#download-pcap-button), and the
