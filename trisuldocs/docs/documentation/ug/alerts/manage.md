...
An “**Alert Group**” represents a type of alert. Trisul is pre-configured with [7 alert types](/docs/documentation/ug/alerts/#types-of-alerts-in-trisul). Each *Alert Group* serves as the logical container for organizing and managing alerts based on their respective types. This section explains how admins can manage individual *alert groups* and configure them in the [*Admin panel*](/docs/documentation/ag/ui/adminlayout).
...
| [Send to Syslog/Email](/docs/documentation/ug/alerts/manage#forward-alerts-to-syslog)| Specify a syslog level to automatically forward all alerts in this group to syslog and email. Select DISABLED to not forward                           |
...
> Once you have clicked ALERTS it is mandatory to restart the probe using [Start/Stop Tasks](/docs/documentation/ag/admintasks/startstop)