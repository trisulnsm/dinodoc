...
The real time alert visualizer is a type of real time stabber. See the section of [Real Time Stabbers](/docs/documentation/ug/cg/stabber) for more. Since it requires browsers with support for WebSockets and LocalStorage, using the latest version of Google Chrome is a safe bet.
...
Adjust the [time window](/docs/documentation/ug/ui/elements#time-selector) shown. The default is the past 24 hours.
...
1. [How to connect Trisul to accept IDS alerts from Snort](/docs/documentation/howto/setup_ids_alerts)
