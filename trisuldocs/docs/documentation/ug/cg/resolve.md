...
1) [From the Key Dashboard](/docs/documentation/ug/cg/resolve#from-the-key-dashboard)
2) [From Top Keys](/docs/documentation/ug/cg/resolve#from-top-keys)
3) [Resolve Names in Bulk using CSV file](/docs/documentation/ug/cg/resolve#resolve-keys-in-bulk-from-csv-file)
4) [Set/Edit Label](/docs/documentation/ug/cg/resolve#setedit-label)
...
2. You will be redirected to [Key Traffic](/docs/documentation/ug/ui/key_dashboard) dashboard  
...
By default in hub config the "resolve ip"" is set to true which automatically resolves IP addresses. You can disable by configuring it in the [hubconfig](/docs/documentation/ref/trisulhubconfig#resolveip).
