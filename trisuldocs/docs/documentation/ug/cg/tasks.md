...
1. Click on the tag on the right side next to any host to open the [Key Dashboard](/docs/documentation/ug/ui/key_dashboard)
...
Now you can apply various [Retro Analysis Tools](/docs/documentation/ug/cg/retrotools) to investigate

### I want to see details of a particular IP, but it isnt showing up anywhere for me to click ?

1. [Use the search box](/docs/documentation/ug/ui/elements#using-search-tool)
...
- Find [Flow Tracker](/docs/documentation/ug/cg/retrotools#flow-trackers) tool in retro dashboard
...
1. Follow instructions in [Using Search](/docs/documentation/ug/ui/elements#using-search-tool)
2. And click **Flows** in Real Time stabbers in [Key
   Details](/docs/documentation/ug/ui/key_dashboard#key-details) modules

See [Real Time Stabber](/docs/documentation/ug/cg/stabber#real-time-stabber-flow-activity)

### Store only 1MB worth of packets of each flow

- Open [Trisul
  Configuration](/docs/documentation/ref/trisulconfig) file as root

- Edit `<Rule mode="FLOWCAP1M"></Rule>`

- Read [Tuning packet storage](/docs/documentation/ug/caps/packetstorage) for
  more examples
...
Click [Keyset Counter Group](/docs/documentation/ag/context/keyset_countergroups) for more.
