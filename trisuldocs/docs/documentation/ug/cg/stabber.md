...
[Key Traffic Stabber](/docs/documentation/ug/cg/stabber#key-traffic-stabber)  

Graphs network traffic of any item in real time. *Example : Plot
transmitted and received traffic of your mail server.*  

[Counter Group Stabber](/docs/documentation/ug/cg/stabber#3-from-the-menu)  

Shows most active items in any counter group. *Example : Show most
active applications by total traffic.*  

[Flow Stabber](/docs/documentation/ug/cg/stabber#real-time-stabber-flow-activity)  

Currently active flows for a host or port. *Example : Show flows for IP
10.18.10.10*  

[Alert Stabber](/docs/documentation/ug/cg/stabber#alert-stabber)  
...
Lets say you are investigating an arbitrary item using the [Key Dashboard](/docs/documentation/ug/ui/key_dashboard)
...
Click and drag to zoom a particular time interval with mouse. Use the [Chart Interaction Controls](/docs/documentation/ug/ui/charts#chart-interaction-controls) and [Legend table](/docs/documentation/ug/ui/charts#legend-table) for further inspection.
...
time visualization. See [Real Time Alert Stabber](/docs/documentation/ug/alerts/ids_stabber) for detailed documentation.
