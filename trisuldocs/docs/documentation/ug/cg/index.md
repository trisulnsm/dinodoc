...
Applications, Hosts, VLAN, MAC, etc. A "Counter Group": [Traffic metering concepts](/docs/documentation/ug/cg/intro) is 
...
You can monitor any metric in real time using [Real time stabbers](/docs/documentation/ug/cg/stabber). This helps with troubleshooting and real time tracking of developing situations.

##### Historical Analysis

Use [retro analysis](/docs/documentation/ug/cg/retro) tools, long term traffic charts, monthly usage reports and other tools 
...
The default mode. Trisul does all its analytics by directly capturing packets from the network. Learn how to [capture packets](/docs/documentation/ag/network/input_packets) for Trisul NSM.

##### NetFlow

Can also accept [Netflow](/docs/documentation/ug/netflow/netflow_setup) v5, v9, SFLOW, and IPFIX instead of packets. This is a powerful 
...
[View all tasks](/docs/documentation/ug/cg/tasks)

### Related Features

[Real Time Stabbbers](/docs/documentation/ug/cg/stabber)
...
[Retro Analysis](/docs/documentation/ug/cg/retro)

Select a time interval and drill down over 100 ways.

[Retro FAQ](/docs/documentation/ug/cg/retrofaq)

Select a time interval and click on pre-defined analysis in Q&A style

[Custom Metering](/docs/documentation/ug/cg/custom)
