...
select a time window using the [*Time Selector*](/docs/documentation/ug/ui/elements#time-selector) and [*Retro Tabs*](/docs/documentation/ug/ui/charts#retro-tabs).
