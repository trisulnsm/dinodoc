...
| ------------- | ----------------------------------------------|
| [Network FAQ](/docs/documentation/ug/cg/retrotools#network-faq)                                       | Complex network analysis like analysing network traffic, flows, and alerts rendered in plain English as a question for easy access.|
| [Counter Group toppers](/docs/documentation/ug/cg/retrotools#counter-group-toppers)                   | Who were the toppers in a counter group for a statistic ? Also shows topper trends in time interval with ability to do a cross drill on any of them              |
| [Investigate IP activity](/docs/documentation/ug/cg/retrotools#investigate-ip-activity)               | Investigate complete activity of a host in selected interval. Details include conversations, flows, security alerts, malware activity, peer connections, upload or download data etc    |
| [Investigate application](/docs/documentation/ug/cg/retrotools#investigate-users-of-an-application)   | Investigate complete activity of an application. Who the top users are of that application and other details split up by upload / download            |
| [Long term traffic charts](/docs/documentation/ug/cg/retrotools#long-term-traffic-charts)             | Used to see daily trends in traffic. Arranges traffic by day on top of each other so you can observe busy hours etc                  |
| [Show traffic chart for an item](/docs/documentation/ug/cg/retrotools#show-traffic-chart-for-an-item) | Draw charts for any item such as a host, app, subnet          |
| [IDSAlerts](/docs/documentation/ug/cg/retrotools#security-alerts-retro)                               | Various views of alert activity seen in selected interval              |
| [Flow trackers](/docs/documentation/ug/cg/retrotools#flow-trackers)                                   | View top flows in the timeframe based on various criteria         |
| [Explore Flows](/docs/documentation/ug/cg/retrotools#explore-flows)                                   | Streaming flow visualization based on the popular<br/>parallel co-ordinates paradigm.             |
| [Traffic Charts](/docs/documentation/ug/cg/retrotools#show-traffic-chart-for-an-item)                 | View usage charts for a particular item for selected time interval.        |
| [Pull packets](/docs/documentation/ug/cg/retrotools#pull-packets)                                     | Get raw packets in tcpdump/libpcap format matching a certain key          |
| [View Edges](/docs/documentation/ug/cg/retrotools#view-edges)                                         | Edges are graph database showing how the metrics are related to each other beyond the flow connection.            |
...
Refer [Retro Q&A](/docs/documentation/ug/cg/retrofaq) for more details.
...
The analysis will take you to the [*Explore Flows*](/docs/documentation/ug/tools/explore_flows) tool with the selected items and time interval.
...
You can click on the [*Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) on the top right for long term traffic charts and click on any date range in the [*Time Frame*](/docs/documentation/ug/ui/elements#time-selector) window to view the traffic for that selected time period. This tool will take you to the [Long term traffic trends](/docs/documentation/ug/tools/analyze_item) tool with the start time and other selections automatically filled in.
...
> You can create your own [flow trackers](/docs/documentation/ug/flow/tracker) They will show up in this dropdown list
...
If you wish to change these settings, go to [App Settings](/docs/documentation/ag/webadmin/web_options) and change the *Deep
...
2. **Packets matching expression** &rarr;[Trisul Filter
   Format](/docs/documentation/ref/trisul_filter_format) is a flexible way of constructing filters. You can enter an expression to run more sophisticated packet queries.  
...
Learn more about Edges in [Trisul Edges](/docs/documentation/ug/edges/)- Streaming Graph Analytics.
