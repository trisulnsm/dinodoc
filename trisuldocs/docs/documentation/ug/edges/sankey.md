...
The Sankey Drill Down App, can be downloaded from [TRISUL Apps](/docs/documentation/ag/webadmin/apps). This visualization tool illustrates the split of traffic for various applications, originating from specific routers and interfaces by providing a graphical representation of traffic distribution.
...
Once downloaded the Sankey shall be available on the [Show All](/docs/documentation/ug/ui/dashmod_intro) dashbaords. Fill in the fields to configure the sankey settings.
