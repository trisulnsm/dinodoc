...
| Tagger Rule      | A string in [Trisul Filter Format](/docs/documentation/ref/trisul_filter_format)                         |

#### Directly Enter the Rule

If you are familiar with the [Trisul Filter Format](/docs/documentation/ref/trisul_filter_format) you may enter the string
...
[Rule Builder](/docs/documentation/ug/tools/rule_builder) or you can also simply click *Add rule* in the Tagger rule to open the Interactive Rule builder and fill up the following fields.
...
Flows](/docs/documentation/ug/tools/aggregate_flows) tool.
...
1. Use the [Flow taggers](/docs/documentation/ug/flow/tagger) tool to see
   a list of top flows for each tag you have set up.
2. Search for flows by tagname using the [Explore
   flows](/docs/documentation/ug/tools/explore_flows) tool.
3. Use the [Aggregate Flows](/docs/documentation/ug/tools/aggregate_flows) tool.
