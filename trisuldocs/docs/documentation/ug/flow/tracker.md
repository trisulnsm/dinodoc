...
also necessary for you to use [flow tracker alerts](/docs/documentation/ug/alerts/ft).

This section outlines the number of things you can do with *Flow Trackers*. 

1) [**View**](/docs/documentation/ug/flow/tracker#view-flow-trackers): View flow data and analytics.
2) [**Manage**](/docs/documentation/ug/flow/tracker#manage-flow-trackers): Manage flow tracking configurations and settings.
3) [**Create**](/docs/documentation/ug/flow/tracker#create-flow-trackers): Create custom flow tracking profiles and criteria.
...
* Step 1: **Select a Time Frame** from the [*Time Selector*](/docs/documentation/ug/ui/elements#time-selector) to narrow down the flow data to a relevant interval.  
...
|Create new Flow Tracker Alert| Flow tracker alerts let you know when certain flows cross thresholds, example when flows in the Download Flow Trackers crosses the value 1GB. See [Flow Tracker Alert](/docs/documentation/ug/alerts/ft) |
...
Also  [Flow Tracker Alert](/docs/documentation/ug/alerts/ft) section.
