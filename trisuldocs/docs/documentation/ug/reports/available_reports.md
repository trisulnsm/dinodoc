...
1) [Readymade Reports](/docs/documentation/ug/reports/readymade) 
2) [Custom Reports](/docs/documentation/ug/reports/flexible_reports) 


## Report Time

For each report type, you can easily select a number of predefined time windows using a [*Time Selector*](/docs/documentation/ug/ui/elements#time-selector)
