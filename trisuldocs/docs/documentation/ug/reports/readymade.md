...
| Malware, botnet, virus infections | Summary of all your internal hosts on the network that might be compromised. This Report template requires the Badfellas plugin. The determination of compromise is based on blacklisting implemented by the [Badfellas plugin](/docs/documentation/ag/install/badfellas)                                          |
...
You can fill in the following fields in *Endpoints and Applications* report by selecting a [time frame](/docs/documentation/ug/ui/elements#time-selector).
...
You can fill in the following fields in *ISP Peering Analytics* report by [selecting a time frame](/docs/documentation/ug/ui/elements#time-selector).
...
You can fill in the following fields in *Commonly Used* report by selecting a [time frame](/docs/documentation/ug/ui/elements#time-selector) and providing the fields required.
...
You can fill in the following fields in *Commonly Used* report by selecting a [time frame](/docs/documentation/ug/ui/elements#time-selector) and providing the fields required. T
...
- Click [*Schedule Report*](/docs/documentation/ug/reports/schedreports#schedule-a-new-report) to schedule this report.
...
- Click *Select Time* and select a time range to generate report for that particular time.
- This will take you to the [*Explore flows result summary*](/docs/documentation/ug/tools/explore_flows#explore-flows-results-summary) of the selected interface.

- Click on the [*Download*](/docs/documentation/ug/tools/explore_flows#export-as-report) button on the to export as a report
...
You can fill in the following fields in *Direct* report by selecting a [time frame](/docs/documentation/ug/ui/elements#time-selector).
...
You can fill in the following fields in *Direct* report by [selecting a time frame](/docs/documentation/ug/ui/elements#time-selector) and providing a static IP.
...
| Report Name                                            | Description                                      |
| ------------------------------------------------------ | ------------------------------------------------ |
| [time frame](/docs/documentation/ug/ui/elements#time-selector)       | Select a time frame to narrow down the data to a relevant interval                                                                                           |
