...
Make sure you have followed the steps in [Switching to a distributed domain](/docs/documentation/ag/domain/change_domain#switching-to-a-distributed-domain) from the default single machine domain.
...
See the [Probe to Context Layer mapping reference ](/docs/documentation/ref/trisulhubconfig#probes)
