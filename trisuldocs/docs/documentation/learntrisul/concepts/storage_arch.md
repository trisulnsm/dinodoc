...
See the [trisulConfig.xml](https://trisul.org/docs/documentation/ref/trisulconfig.html) documentation for more details.
...
For detailed syntax for specifying the rule chain, see the Ring section in [trisulConfig.xml](https://trisul.org/docs/documentation/ref/trisulconfig.html#ring)
...
To change the passphrase, see the *PassphraseFile* parameter in [trisulConfig.xml](https://trisul.org/docs/documentation/ref/trisulconfig.html#ring)



The raw packets are stored for each context in the following default directories. The*App > DBRoot*parameter in [trisulProbeConfig.xml](/docs/documentation/ref/trisulconfig) points to the base directory
