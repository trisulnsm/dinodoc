...
2. Edit the `LicenseFile` parameter in [trisulProbeConfig.xml](/docs/documentation/ref/trisulconfig#app ) to point to the new file. 
...
1. Change the name of the new file to `LicenseKey.txt` *OR*
2. Edit the `LicenseFile` parameter in [trisulHubConfig.xml](/docs/documentation/ref/trisulconfig#app ) to point to the new file. 
