...
Trisul’s four products fall into two technical categories based on how they process data. See [**Input Processing Modes**](/docs/documentation/starthere/what_is_trisul/dataflow#input-processing-modes).
