...
You can install it after completing [Trisul package installation](/docs/documentation/ag/install/doinstall) and [selecting the product mode](/docs/documentation/ag/install/selectmode).
