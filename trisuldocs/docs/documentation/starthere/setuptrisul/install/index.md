...
This section covers how to get a *single box* installation of Trisul up and running. For distributed installation see [**Distributed monitoring**](/docs/documentation/learntrisul/concepts/)  
