...
See [System Requirements](/docs/documentation/starthere/setuptrisul/install/requirements)
...
Follow directions on [Installing Trisul](/docs/documentation/starthere/setuptrisul/install/doinstall)


### Step 4: Configure the Network SPAN port or NETFLOW 

Next, you need to send something to Trisul to start monitoring [Send Packets](/docs/documentation/starthere/setuptrisul/network/input_packets)  and/or [Send NetFlow](/docs/documentation/starthere/setuptrisul/network/input_netflow)


### Step 5: Login and start viewing 

Congratulations! You are on Trisul.  Things to do on [First Login](/docs/documentation/starthere/setuptrisul/install/selectmode)
