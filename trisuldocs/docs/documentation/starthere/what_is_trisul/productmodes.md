...
See [**Processing Modes**](/docs/documentation/starthere/what_is_trisul/dataflow#input-processing-modes) to learn how network data enters and is processed by Trisul.
...
To learn how to select a Product Mode during installation, see [**Selecting a Product Mode**](/docs/documentation/starthere/setuptrisul/install/selectmode).