...
Here are some commonly used config files.
 ...
 - The main Trisul-HUB config file : [trisulHubConfig.xml](/docs/documentation/ref/trisulhubconfig)
 - The Netflow config file : [netflow-config](netflow-config) 

## Plugin Config files

Each subsystem has its own config file. The files are named PI-xxxx.xml See [Plugin Configuration](/docs/documentation/ref/plugin_configuration)
