...
Locate the [rules.xml file](/docs/documentation/ag/install/badfellas)
...
See the [Badfellas Malware alerts section](/docs/documentation/ug/alerts/mw) in the User Guide
