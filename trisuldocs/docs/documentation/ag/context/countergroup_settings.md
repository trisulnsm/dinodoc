...
- To the right, access the [column selector](/docs/documentation/ug/ui/elements#column-selector). 
...
> Note that all the columns are [column sortable](/docs/documentation/ug/ui/elements#column-sorter). 
