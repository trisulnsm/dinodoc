...
- Via HTTP on port *3000*. [Instructions to change this to another port](/docs/documentation/howto) 
...
[Contexts](/docs/documentation/learntrisul/concepts/contexts) are multiple analysis domains in Trisul. At login time you must select the context you wish to analyze. Hover your mouse over each context name to get a description of what the context contains.
