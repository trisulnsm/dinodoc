...
See [Home Network Concepts](/docs/documentation/learntrisul/homenetwork_concepts)
...
1. Enable the [TagFlowsWithDirection](pathname:///docs/documentation/ref/netflow-config#TagFlowsWithDirection) setting in the NetFlow configuration file
...
Also see user guide sections: [Flow Taggers](/docs/documentation/ug/flow/tagger), [Explore Flows](/docs/documentation/ug/tools/explore_flows)
