...
| BPF Filter         | A BPF (libpcap/tcpdump) filter expression (see [notes below](/docs/documentation/ag/context/profiles#specifying-a-bpf-filter-for-afpacket-and-rxring) on how to generate this for rxring mode - the default) |
