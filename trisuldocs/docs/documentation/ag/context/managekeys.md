...
*Manage Keys* allows you to view and manage the [keys](/docs/documentation/ug/cg/intro#a-key) on Trisul platform.
...
> Note that each column in the table is [sortable](/docs/documentation/ug/ui/elements#column-sorter) for flexible data analyses.
