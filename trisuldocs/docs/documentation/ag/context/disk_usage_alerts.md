...
Specify outgoing email server credentials. see [Setup Email](/docs/documentation/ug/reports/emailsettings)

**Enable email alert delivery**

Allow alert delivery via email see [Email alert delivery](//docs/documentation/ag/webadmin/emailsettings)
...
Edit the [trisulHubConfig.xml](/docs/documentation/ref/trisulhubconfig) file and set the following parameters under SlicePolicy.
...
Edit the [trisulProbeConfig.xml](/docs/documentation/ref/trisulconfig) file and set the following value.
