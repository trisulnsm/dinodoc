...
:memo: See: [Storage Architecture](/docs/documentation/ag/domain/storage_arch) in the Concepts section. Reading this architecture overview first will make retention and disk decisions easier to reason about. 
