...
To search for a particular log from the log entries, click on the [*Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) to open up the search criteria form. Search and locate a particular log by filling in the following fields.
...
To search for a particular log from the background tasks log entries, click on the *Show Search Form* and fill in the [search criteria form](/docs/documentation/ag/webadmin/logs#search-criteria).
...
To search for a particular log from the web socket log entries, click on the *Show Search Form* and fill in the [search criteria form](/docs/documentation/ag/webadmin/logs#search-criteria).

## Auth Log 

See : [Auth Log](/docs/documentation/ag/webadmin/authlog)
...
To search for particular email logs, click on the *Show Search Form* and select the time range using the [*Time Selector*](/docs/documentation/ug/ui/elements#time-selector) to narrow down the email log entries in the selected time range.
...
Also see `trisbashrc:“/docs/documentation/ref/trisbashrc.html` which contains helper
