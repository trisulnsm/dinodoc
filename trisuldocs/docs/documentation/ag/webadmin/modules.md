...
> **Each column in the table is [column sortable](/docs/documentation/ug/ui/elements#column-sorter)**
...
Click *Add New Module* Button from the header to create a new module from scratch. Select a module template and fill out the fields to [create a new module](/docs/documentation/ug/ui/modules#creating-modules).
