...
| [Action](/docs/documentation/ag/webadmin/emailsettings#action) | Dropdown options to performa a number of actions including edit, delete, send a test mail, and remove an email id from all reports. |
