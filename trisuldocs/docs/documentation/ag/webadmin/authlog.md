...
Click on the [*Show Search Form*](/docs/documentation/ug/ui/elements#hide-show-search-form) to expand the *Search Criteria* Form for *Auth Log*. The *Search Criteria* form enables you to search for particular user/context and click **Search**.
...
Click on the [*Download Button*](/docs/documentation/ug/ui/elements#download-button) to download the list of auth logs in PDF, XLSV, or CSV formats.

### Users List

Click on the [*Users List*](/docs/documentation/ag/webadmin/manageusers) Button to view the list of all active users.