...
| Option                 | Default Value | Description                                |
| ---------------------- | ------------- | ------------------------------------------ |
| Idle Timeout (minutes) | 60            | Time set to logged webtrisul when idle. See [Inactivity Security Timeout](/docs/documentation/ag/context/login#inactivity-security-timeout)     |
