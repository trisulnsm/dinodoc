...
| Authentication       | User can use [LDAP](/docs/documentation/ag/webadmin/ldap_login) password to login |
...
- Click the [*Account button*](/docs/documentation/ug/ui/userlayout#account) at the upper right hand side of the page to open the dropdown menu and
- Click *My Account*  
...
- The only password constraint is the minimum number of characters i.e.length which can be customized through the [**Web Trisul server : App Settings**](/docs/documentation/ag/webadmin/web_options#ui) and specify the minimum number of characters by specifying in the "User Password Minimum length".

## Password Policy

- For security reasons, we do **not** store previously entered passwords.
- Passwords do **not** expire.
- You can reset your password at any time using [**Reset Settings**](/docs/documentation/ag/webadmin/manageusers#reset-password-by-admin)
...
> - An active SMS gateway has been configured under [**Web Admin → Manage → SMS Configurations**](/docs/documentation/ag/webadmin/smsconfig).
