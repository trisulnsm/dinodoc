...
file](/docs/documentation/ref/trisulconfig) to connect to IDS alerts from
barnyard2.
...
change it read [Change capture adapter](/docs/documentation/ag/context/profiles)
...
For more see [Relocate database](/docs/documentation/ag/basictasks/reloc.md) or type
...
Netflow](/docs/documentation/ug/netflow/netflow_setup) to start consuming Netflow
...
Netflow](/docs/documentation/ug/netflow/netflow_setup) on the nf1 context.
...
Probe](/docs/documentation/ag/domain/deploy_probe)

### How to change network interfaces amd web server ports

\* Listen on an interface other than eth0
[Docs](/docs/documentation/ag/context/profiles) 
\* Move Web server ports from 3000 and 3003
[Docs](/docs/documentation/howto/change_web_port)  
\* Enable SSL for the web interface [Docs](/docs/documentation/howto/sslforwebtr)
...
1. [BadFellas](/docs/documentation/ag/install/badfellas)
2. [Geo](/docs/documentation/ag/install/geoasn)
