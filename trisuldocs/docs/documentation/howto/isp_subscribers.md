...
described in the [Manage Users](/docs/documentation/ag/webadmin/userroles)
...
- Click on the **See utilization for entire week** to view [long term
  usage charts](/docs/documentation/ug/tools/analyze_item)
...
[context](/docs/documentation/ag/domain#contexts). This will allow the user
