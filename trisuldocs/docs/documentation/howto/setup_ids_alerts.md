...
[IDSAlerts UnixSocket](/docs/documentation/ref/trisulconfig#ids-alerts) parameter
...
[IDSAlert/UnixSocket](/docs/documentation/ref/trisulconfig#ids-alerts) parameter
in the config file.

#### How to read a PCAP file and generate alerts

A new tool called [importpcap\_ids](/docs/documentation/ag/basictasks/snort.md) uses
