...
- ##### Step 1: Mount new partition
  ...
  Create a new partition with enough space and mount the new partition, say on`/mnt/trisul_extra`[Trisul Hub Configuration File - Trisul Documentation](/docs/documentation/ref/trisulhubconfig)
...
1. [trisulProbeConfig.xml](/docs/documentation/ref/trisulconfig)– for setting max GB retention of pcaps.
2. [trisulHubConfig.xml](/docs/documentation/ref/trisulhubconfig)– for setting days of metrics.
...
7. Try to use[PCAPpruning rules](/docs/documentation/ug/caps/packetstorage)eg, dont store Netflix,YouTube videos packets
