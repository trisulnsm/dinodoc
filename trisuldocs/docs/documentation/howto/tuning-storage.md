...
Tuning](/docs/documentation/ug/flow/tuning#optimize-flow-handling)
...
- You can disable Edges by opening the Trisul Config file and disable
  ...
  trisulProbeConfig](/docs/documentation/ref/trisulconfig#edges)
...
See [Counter Group Settings](/docs/documentation/ag/context/countergroup_settings)Ensure you replace the demo certificate and key with new ones specific for your organization as described below
