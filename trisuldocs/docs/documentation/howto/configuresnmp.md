...
:::info navigation
:point_right: Go to [Key Dashboard](/docs/documentation/ug/ui/key_dashboard) &rarr; Set Label/Edit &rarr; Assign User Label/ Edit Attributes &rarr; Attributes
:::
...
:::info navigation
:point_right: Go to [Trisul Apps](/docs/documentation/ag/webadmin/apps#types-of-apps) &rarr; Install **Meta App for SNMP**
:::
