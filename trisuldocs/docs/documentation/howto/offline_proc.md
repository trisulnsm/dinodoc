...
concepts](/docs/documentation/ag/domain#contexts)

The tools we use to import PCAP dumps support working with contexts.

## Step by step Import PCAPS

Read the document [Importing PCAP Dumps](/docs/documentation/ug/caps/pcap_import)
for step by step instructions.
...
with IDS](/docs/documentation/ag/basictasks/snort.md)
