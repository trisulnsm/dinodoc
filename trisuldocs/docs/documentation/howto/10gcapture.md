...
[`InflightTokens`](/docs/documentation/ref/trisulconfig#tuning) parameter in the
[config file](/docs/documentation/ref/trisulconfig#tuning) . By default the value
...
3. Disable TCP reassembly if you are only interested in basic metering.
   ...
   reassembly](/docs/documentation/ref/trisulconfig#reassembly) options to FALSE
