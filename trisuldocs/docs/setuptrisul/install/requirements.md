...
Trisul’s four products fall into two technical categories based on how they process data. See [**Input Processing Modes**](/docs/ug/intro/dataflow#input-processing-modes).
