...
If you’re setting up Trisul for the first time, this is exactly where you should start. All [**four Trisul products**](/docs/setuptrisul/install/selectmode) run on the same core platform, so the setup and first-time guidance steps you’ll see here apply across every product. 
