...
Your script can use [`T.log(..)`](https://trisul.org/docs/lua/obj_globalt#function_t.log) to log into the Trisul probe log files and take advantage of all of its features. You can also use the standard LUA `print(..)` statements in your code to debug your script.
