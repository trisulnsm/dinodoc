...
## [Structure](https://trisul.org/docs/lua/sg_monitor.html#structure)
...
| [onnewflow](https://trisul.org/docs/lua/sg_monitor.html#function_onnewflow)       | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), [flow](https://trisul.org/docs/lua/sg_monitor.html#flow)) | A new flow was seen. The [Flow](https://trisul.org/docs/lua/sg_monitor.html#flow) contains details of the flow |
| [onupdate](https://trisul.org/docs/lua/sg_monitor.html#function_onupdate)         | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), [flow](https://trisul.org/docs/lua/sg_monitor.html#flow)) | Some metrics were update in the flow object. This can be called as much as every second per flow.              |
| [onterminate](https://trisul.org/docs/lua/sg_monitor.html#function_onterminate)   | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), [flow](https://trisul.org/docs/lua/sg_monitor.html#flow)) | Flow terminated                                                                                                |
| [onbeginflush](https://trisul.org/docs/lua/sg_monitor.html#function_onbeginflush) | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), ts)                                                       | Before starting to flush all metrics to db                                                                     |
| [flushfilter](https://trisul.org/docs/lua/sg_monitor.html#function_flushfilter)   | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), [flow](https://trisul.org/docs/lua/sg_monitor.html#flow)) | Before flushing each flow. Return *true* if you want to save flow in DB, return *false* to skip this flow      |
| [onflush](https://trisul.org/docs/lua/sg_monitor.html#function_onflush)           | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), [flow](https://trisul.org/docs/lua/sg_monitor.html#flow)) | Called for each flow as they are being flushed                                                                 |
| [onendflush](https://trisul.org/docs/lua/sg_monitor.html#function_onendflush)     | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html))                                                           | After all flows have been flushed for this interval                                                            |
| [onmetronome](https://trisul.org/docs/lua/sg_monitor.html#function_onmetronome)   | Function( [Engine](https://trisul.org/docs/lua/obj_engine.html), timestamp, tick_count, tick_interval)                     | called every second ( Tick Interval)                                                                           |
...
| flow             | [FlowID](https://trisul.org/docs/lua/obj_flowid.html)                   | a FlowID object representing the flow tuples like source_ip, port, destination_ip, port etc                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| state            | [flow state](https://trisul.org/docs/lua/sg_monitor.html#session_state) | The state of the flow, whether it is timeout, RST, FIN, or closed normally.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
