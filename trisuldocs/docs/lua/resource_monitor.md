...
| [onnewresource](/docs/lua/resource_monitor#functiononnewresource)     | function([engine](/docs/lua/obj_engine), [resource](/docs/lua/resource_monitor#objects-reference)) | A new resource was seen. Sent within 1 sec of seeing the [resource](/docs/lua/resource_monitor#objects-reference)        |
