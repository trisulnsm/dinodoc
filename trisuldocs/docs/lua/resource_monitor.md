...
| [onflush](/docs/lua/resource_monitor#function-onflush)           | function([engine](/docs/lua/obj_engine), [resource](/docs/lua/resource_monitor#objects-reference)) | Called for each resource as they are being flushed                                                                                         |
| [onendflush](/docs/lua/resource_monitor#function-onendflush)     | function([engine](/docs/lua/obj_engine), [resource](/docs/lua/resource_monitor#objects-reference)) | After all resource have been flushed for this interval                                                                                     |
