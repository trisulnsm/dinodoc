...
To create a new context, follow the provided link: [Creating a new context](https://docs.trisul.org/docs/documentation/ag/domain/contexts/#creating-a-new-context)
...
To generate an API key, follow the provided link: [Generate API token](https://docs.trisul.org/docs/documentation/ag/webadmin/manageusers#generate-api-token)
