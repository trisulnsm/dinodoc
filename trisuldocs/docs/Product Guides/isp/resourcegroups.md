...
:::note
If you cannot find SNMP-Interface from the list of counter groups. Install *SNMP-Poller* from [Trisul Apps](/docs/documentation/ag/webadmin/apps) before this step and try again.
:::
