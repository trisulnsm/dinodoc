...
Configure SMTP servers, report delivery schedules, and recipient lists.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Email Settings** is located under the **Reports** menu.
...
- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to email settings.
...
1. Navigate to **Reports &rarr; Email Settings** from the left-hand navigation panel.
