...
Browse and manage all available report templates and custom scheduled reports.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Show all** is located under the **Reports** menu.

:::info Navigation
:point_right: Go to **Reports &rarr; Show all**
:::

## Key Features

- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to show all.
...
1. Navigate to **Reports &rarr; Show all** from the left-hand navigation panel.
