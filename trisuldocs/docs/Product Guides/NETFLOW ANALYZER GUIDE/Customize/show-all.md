...
Directory of all user customization settings and interface preferences.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Show all** is located under the **Customize** menu.

:::info Navigation
:point_right: Go to **Customize &rarr; Show all**
:::
...
1. Navigate to **Customize &rarr; Show all** from the left-hand navigation panel.
