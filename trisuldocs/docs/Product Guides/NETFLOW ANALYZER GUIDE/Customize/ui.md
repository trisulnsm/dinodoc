...
Customize user interface layout, color themes, navigation menus, and organization logos.

## Overview

In the Trisul NetFlow Analyzer Web UI, **UI** is located under the **Customize** menu.
...
- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to ui.
...
1. Navigate to **Customize &rarr; UI** from the left-hand navigation panel.
