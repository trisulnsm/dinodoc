...
* Connections transferring the most data
* Large data transfers **out of** your network
* Large data transfers **into** your network
* Connections that have remained active for a long time
* TCP connections transferring significant amounts of actual data
