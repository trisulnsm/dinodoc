...
Long-term trend analysis, historical traffic pattern comparison, and growth forecasting.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Long term traffic** is located under the **Tools** menu.
...
- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to long term traffic.
...
1. Navigate to **Tools &rarr; Long term traffic** from the left-hand navigation panel.
