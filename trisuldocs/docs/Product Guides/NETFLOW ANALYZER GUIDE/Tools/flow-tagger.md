...
Rule-based tagging to categorize flows by department, application, or security policy.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Flow Tagger** is located under the **Tools** menu.
...
- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to flow tagger.
...
1. Navigate to **Tools &rarr; Flow Tagger** from the left-hand navigation panel.
