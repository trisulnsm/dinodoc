...
Automated and scheduled flow export routines for archival and data streaming.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Export Flows** is located under the **Tools** menu.

:::info Navigation
:point_right: Go to **Tools &rarr; Export Flows**
:::

## Key Features

- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to export flows.
...
1. Navigate to **Tools &rarr; Export Flows** from the left-hand navigation panel.
