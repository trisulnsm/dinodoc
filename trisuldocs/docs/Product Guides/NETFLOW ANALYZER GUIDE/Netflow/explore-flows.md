...
Flow exploration tailored specifically to NetFlow router, interface, and TCP flag attributes.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Explore Flows** is located under the **Netflow** menu.

:::info Navigation
:point_right: Go to **Netflow &rarr; Explore Flows**
:::
...
1. Navigate to **Netflow &rarr; Explore Flows** from the left-hand navigation panel.
