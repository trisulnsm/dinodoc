...
Both offices need the same setup: the same monitoring equipment, measurements, flow tracking, and alerts. Instead of configuring both offices separately, you use the same Profile for both.

If you create another office with the same requirements, you simply assign the same profile to it.
