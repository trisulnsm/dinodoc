...
Active sessions. Also can use [Meta Session Group > Master Size ](/docs/guide/counter-groups/meta-session-group#master-size)
...
See [cardinality counters](/docs/guide/ag/context/cardinality_countergroups)