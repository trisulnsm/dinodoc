...
IPv6 Hosts in HOME NETWORK

## Counter group

| GUID                                     | TYPE       | Bucke Size (secs) | Topper Bucket(Secs): |
| ---------------------------------------- | ---------- | ----------------- | --------------------- |
| `{0BDE3B47-B465-43DD-9275-45829D9A9748}` | Stat Based | 60                 | 300                    |

## Meter list

| ID  | DESCRIPTION       | TOP COUNT | BOTTOM COUNT | TYPE                | UNITS   | DESCRIPTION |
| --- | ------------------- | --------- | ------------ | ------------------- | ------- |-------------|
| 0   | Total                  | 50        | 0            | VT_RATE_COUNTER     | Bps     | This meter reports the total bandwidth seen by this host in both the transmit and receive direction, for IPv6 hosts located inside the home network. |
...
| 6   | Homenet                | 20        | 0            | VT_RATE_COUNTER     | Bps     | This meter reports the traffic bandwidth for conversations between this host and another host inside the home network. |
| 7   | External               | 20        | 0            | VT_RATE_COUNTER     | Bps     | This meter reports the traffic bandwidth for conversations between this host and a host outside the home network. |
...
| 14  | Into Interface         | 20        | 0            | VT_RATE_COUNTER     | Bps     | This meter appears only in a filtered counter group where the parent counter group is Internal Hosts v6 and the filter is a NetFlow interface. When used with the NetFlow Interface Tracker, it reports bandwidth involving this address as source or destination that is ingressing the interface specified in the interface tracker. |
| 15  | Outof Interface        | 20        | 0            | VT_RATE_COUNTER     | Bps     | This meter appears only in a filtered counter group where the parent counter group is Internal Hosts v6 and the filter is a NetFlow interface. When used with the NetFlow Interface Tracker, it reports bandwidth involving this address as source or destination that is egressing the interface specified in the interface tracker. |
