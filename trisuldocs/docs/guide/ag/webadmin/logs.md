...
To search for a particular log from the web socket log entries, click on the *Show Search Form* and fill in the [search criteria form](/docs/guide/ag/webadmin/logs#search-criteria).

## Auth Log 

See : [Auth Log](/docs/guide/ag/webadmin/authlog)
