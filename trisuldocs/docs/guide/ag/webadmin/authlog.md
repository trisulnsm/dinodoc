...
Click on the [*Show Search Form*](/docs/guide/ug/ui/elements#hide-show-search-form) to expand the *Search Criteria* Form for *Auth Log*. The *Search Criteria* form enables you to search for particular user/context and click **Search**.
...
Click on the [*Users List*](/docs/guide/ag/webadmin/manageusers) Button to view the list of all active users.