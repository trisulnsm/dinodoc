...
1) [Restart Web Server](/docs/guide/ag/webadmin/startorstop_tasks#restart-web-server)
2) [Restart Email Notification Service](/docs/guide/ag/webadmin/startorstop_tasks#email-notification-service)
