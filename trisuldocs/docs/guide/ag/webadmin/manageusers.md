...
- Click the [*Account button*](/docs/guide/ug/ui/userlayout#account) at the upper right hand side of the page to open the dropdown menu and
- Click *My Account*  
...
> - An active SMS gateway has been configured under [**Web Admin → Manage → SMS Configurations**](/docs/guide/ag/webadmin/smsconfig).
