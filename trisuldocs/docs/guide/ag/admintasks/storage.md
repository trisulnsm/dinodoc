...
:memo: See: [Storage Architecture](/docs/guide/learntrisul/concepts/storage_arch) in the Concepts section. Reading this architecture overview first will make retention and disk decisions easier to reason about. 
