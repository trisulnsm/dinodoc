...
Specify outgoing email server credentials. see [Setup Email](/docs/guide/ug/reports/emailsettings)
...
Edit the [trisulHubConfig.xml](/docs/guide/ref/trisulhubconfig) file and set the following parameters under SlicePolicy.
...
Edit the [trisulProbeConfig.xml](/docs/guide/ref/trisulconfig) file and set the following value.
