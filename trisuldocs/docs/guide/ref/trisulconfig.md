...
Also see [trisulHubConfig.xml](/docs/guide/ref/trisulhubconfig) for editing Hub node parameters 
...
- Each rule is an expression in the [Trisul filter format](/docs/guide/ref/trisul_filter_format)
