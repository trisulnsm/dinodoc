...
On the Trisul-Probe type `sudo /usr/local/share/trisul-probe/cfgedit` then select “Netflow” to edit.  See [Plugin Configuration](/docs/guide/ref/plugin_configuration)
