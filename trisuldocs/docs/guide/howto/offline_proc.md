...
concepts](/docs/guide/learntrisul/concepts/contexts)

The tools we use to import PCAP dumps support working with contexts.

## Step by step Import PCAPS

Read the document [Importing PCAP Dumps](/docs/guide/ug/caps/pcap_import)
for step by step instructions.
...
with IDS](/docs/guide/ag/basictasks/snort.md)
