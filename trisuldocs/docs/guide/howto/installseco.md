...
file](/docs/guide/ref/trisulconfig) to connect to IDS alerts from
barnyard2.
...
change it read [Change capture adapter](/docs/guide/ag/context/profiles)
...
For more see [Relocate database](/docs/guide/ag/basictasks/reloc.md) or type
...
Netflow](/docs/guide/ug/netflow/netflow_setup) to start consuming Netflow
...
Netflow](/docs/guide/ug/netflow/netflow_setup) on the nf1 context.
...
Probe](/docs/guide/learntrisul/concepts/deploy_probe)

### How to change network interfaces amd web server ports

\* Listen on an interface other than eth0
[Docs](/docs/guide/ag/context/profiles) 
\* Move Web server ports from 3000 and 3003
[Docs](/docs/guide/howto/change_web_port)  
\* Enable SSL for the web interface [Docs](/docs/guide/howto/sslforwebtr)
...
1. [BadFellas](/docs/guide/ref/plugin-config/badfellas#installation)
2. [Geo](/docs/guide/ref/plugin-config/geoasn#setup)
