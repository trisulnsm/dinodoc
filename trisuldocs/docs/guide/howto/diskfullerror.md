...
1. [trisulProbeConfig.xml](/docs/guide/ref/trisulconfig)– for setting max GB retention of pcaps.
2. [trisulHubConfig.xml](/docs/guide/ref/trisulhubconfig)– for setting days of metrics.
