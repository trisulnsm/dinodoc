...
|---|---|
| [Layer 7 Metrics](/docs/guide/ug/nbad/layer7metrics) | Application-layer breakdown: top apps, SNIs, TLS Root CAs, DNS traffic |
| [HTTP Traffic](/docs/guide/ug/nbad/httptraffic) | HTTP method, status code, content type, host, and URL-level visibility |
| [IPv4 / IPv6 Dashboard](/docs/guide/ug/nbad/ipv4ipv6) | Side-by-side breakdown of IPv4 vs IPv6 host and application activity |
| [Tunnels](/docs/guide/ug/nbad/tunnels) | Detection of encapsulated and tunneled protocols |
| [DDoS Metrics](/docs/guide/ug/alerts/ddos) | DDoS attack detection and analysis |  
| [P2P Analytics](/docs/guide/ug/nbad/p2p) | Peer-to-peer traffic: BitTorrent, Tor, Gnutella, eMule, and more |
| [TCP Analyzer](/docs/guide/ug/nbad/tcpanalyzer) | TCP health metrics: latency, retransmissions, timeouts, poor-quality flows |
| [Flow Map](/docs/guide/ug/nbad/flowmap) | Live geographic map of network session flows |
