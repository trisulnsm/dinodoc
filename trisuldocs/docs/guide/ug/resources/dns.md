...
As shown in the figure, each question in the [*search results*](/docs/guide/ug/resources/dns#search-results) has a corresponding answer in the form of a resolved IP address.
...
Open the Search Criteria box by clicking on [*Show Search Form*](/docs/guide/ug/ui/elements#hide-show-search-form) and fill in the fields with the help of following field descriptions. Click on the [*Download Button*](/docs/guide/ug/resources/oveview#download) to download only the contents as a text file.
| Fields               | Descriptions                                                                            |
|----------------------|-----------------------------------------------------------------------------------------|
...
The first section of the search result contains a summary of "grouped by" information on Source IP, Destination IP, and Resources. Interactive functionalities on the search result include : [*Toggle Labels*](/docs/guide/ug/ui/elements#toggle-labels), [*Download*](/docs/guide/ug/ui/elements#download-button), and [*Download PCAP*](/docs/guide/ug/ui/elements#download-pcap-button)

And the matching resources are displayed in the search result table with the [*Column Sorter*](/docs/guide/ug/ui/elements#column-sorter) that include the following details.
...
| [Options](/docs/guide/ug/resources/dns#option-button)          | Provides additional actions or options for each resource, such as viewing details or downloading PCAP files                                                                                           |
