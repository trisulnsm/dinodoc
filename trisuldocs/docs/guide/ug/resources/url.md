...
Interactive functionalities on the search result include : [*Toggle Labels*](/docs/guide/ug/ui/elements#toggle-labels), [*Download*](/docs/guide/ug/ui/elements#download-button), and [*Download PCAP*](/docs/guide/ug/ui/elements#download-pcap-button)
