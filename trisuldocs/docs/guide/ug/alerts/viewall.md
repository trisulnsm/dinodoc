...
1) [*Alert Bar*](/docs/guide/ug/alerts/viewall#the-alert-bar) ( Top right corner of every page)
2) [*Show All*](/docs/guide/ug/alerts/viewall#the-show-all-alerts) Alerts
...
The *Alert Bar* is located in the top right corner of every page on the [User's Layout](/docs/guide/ug/ui/userlayout). 
