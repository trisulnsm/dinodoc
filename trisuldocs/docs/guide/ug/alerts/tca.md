...
1) [**View individual alerts**](/docs/guide/ug/alerts/tca#view-individual-alerts)
2) [**Filter Individual Alerts**](/docs/guide/ug/alerts/tca#filter-individual-alerts) using the *Search Form* based on certain search criteria, filter individual alerts based on certain search criteria 
3) [**In-Depth Analysis of Individual Alerts**](/docs/guide/ug/alerts/tca#in-depth-analysis-of-individual-alerts) using the *Drilldown* button
4) [**View Traffic Chart**](/docs/guide/ug/alerts/tca#traffic-chart) with watermarks around the alert timestamp.
...
- **Download Button**: Click on the [download](/docs/guide/ug/ui/elements#download-button) button at the top of the alerts to get the alert details downloaded in the form of PDF and XLSX. 
...
To facilitate targeted queries, a *search form* with [*Hide/Show Search Form*](/docs/guide/ug/ui/elements#hide-show-search-form) option is provided, that allows you to specify a temporal range and a regular expression (*regex*) pattern to filter alerts.   
...
[**Time Frame**](/docs/guide/ug/ui/elements#time-selector) Specify a temporal range to restrict search results to alerts generated within that timeframe.  
...
> You can create a Threshold Crossing Alerts(TCA) Module using [Module Templates](/docs/guide/ug/ui/module_templates#alert-list) and add that module to any dashboard. And this module keeps auto updating itself as new TCA are generated. 
...
> Enabling [interface tracking](/docs/guide/ug/netflow/interface_tracker) allows for richer TCA alerts.
