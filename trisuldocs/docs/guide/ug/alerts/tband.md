...
:::info navigation
:point_right: Click on any *key* in a chart&rarr; From [Key Dashboard](/docs/guide/ug/ui/key_dashboard)&rarr; Create Threshold Band
:::
...
| [View Training Data](/docs/guide/ug/alerts/tband#view-training-data)   | Select one from the drop down menu to view training data separately for each day (sun, mon, tue, wed, thu, fri, sat)                                                                                    |
| [Option Button](/docs/guide/ug/alerts/tband#option-button)        | By clicking on the option button you can choose to view alerts, edit, and delete        |
