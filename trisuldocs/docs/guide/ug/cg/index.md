...
Applications, Hosts, VLAN, MAC, etc. A "Counter Group": [Traffic metering concepts](/docs/guide/ug/cg/intro) is 
...
You can monitor any metric in real time using [Real time stabbers](/docs/guide/ug/cg/stabber). This helps with troubleshooting and real time tracking of developing situations.

##### Historical Analysis

Use [retro analysis](/docs/guide/ug/cg/retro) tools, long term traffic charts, monthly usage reports and other tools 
...
The default mode. Trisul does all its analytics by directly capturing packets from the network. Learn how to [capture packets](/docs/guide/starthere/setuptrisul/network/input_packets) for Trisul NSM.
...
[View all tasks](/docs/guide/ug/cg/tasks)
...
[Retro Analysis](/docs/guide/ug/cg/retro)
...
[Custom Metering](/docs/guide/ug/cg/custom)
