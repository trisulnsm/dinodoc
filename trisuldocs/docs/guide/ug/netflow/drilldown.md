...
Interfaces Tool](/docs/guide/ug/netflow/routers_and_interfaces)
:::
...
Click the **Show Search Form** on the [top right](/docs/guide/ug/ui/elements#hide-show-search-form) to open up a form where you can control the following.
...
Counter Group](/docs/guide/ag/context/crosskey_countergroups) with Flow-Interfaces as the first group, then the second group will be shown as a Tab.
...
[Interface Tracker](/docs/guide/ug/netflow/interface_tracker) .
...
enabling [Interface Tracker](/docs/guide/ug/netflow/interface_tracker) .
...
sending or receiving traffic from the subject interface. This is only available after enabling [Cross Key](/docs/guide/ag/context/crosskey_countergroups) ![](images/interface_matrix_light.png)

*Figure: Interface Traffic Matrix*

## ASN, NBAR, and Other Details

These are available in the interface drilldowns if the proper trackers are created ahead of time when [Cross Key](/docs/guide/ag/context/crosskey_countergroups) is enabled for them.
