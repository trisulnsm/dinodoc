...
| Tagger Rule      | A string in [Trisul Filter Format](/docs/guide/ref/trisul_filter_format)                         |
...
Flows](/docs/guide/ug/tools/aggregate_flows) tool.
...
3. Use the [Aggregate Flows](/docs/guide/ug/tools/aggregate_flows) tool.
