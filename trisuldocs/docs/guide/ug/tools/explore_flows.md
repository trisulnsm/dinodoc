...
1. [**Quick search**](/docs/guide/ug/tools/explore_flows#quick-search-enter-search-terms-directly) a search expression directly like
   `destip=twitter.com,port=ssh`
2. [**Advanced search**](/docs/guide/ug/tools/explore_flows#advanced-search--use-a-form) use a form to enter individual fields
...
1) [**Parallel Co-ords**](/docs/guide/ug/tools/explore_flows#using-the-interactive-visualization): An interactive visualization based on parallel co-ordinates
2) [**Activity Details**](/docs/guide/ug/tools/explore_flows#activity-details): A summary of hosts and application by upload/download, peers
...
5. **Flow taggers**: Displays tags or labels assigned to flows related to the searched IP address, helping identify specific types of traffic. (see [Flow Taggers](/docs/guide/ug/flow/tagger) )
