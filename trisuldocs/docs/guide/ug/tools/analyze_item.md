...
The following *search criteria* window opens up with a [*Hide/ Show Search Form*](/docs/guide/ug/ui/elements#hide-show-search-form) option.
...
| [Time Frame](/docs/guide/ug/ui/elements#time-selector)    | Define the time range for the chart                         |
...
Using the [legend table](/docs/guide/ug/ui/charts#legend-table) and [Chart Interaction Controls](/docs/guide/ug/ui/charts#chart-interaction-controls), you can drill down into the intra-day data, facilitating a more detailed temporal analysis and exploration of the search result.
