...
:::
The following *Search criteria* form opens up with the [*Hide/ Show Search Form*](/docs/guide/ug/ui/elements#hide-show-search-form) option.
...
| [Time Frame](/docs/guide/ug/ui/elements#time-selector)   | Defines the time period of retrieval							|
| Max items 					               	     | Limits the number of results returned 						|
| [Key Space](/docs/guide/ug/tools/keyspace#key-space-list)| Specifies the search scope such as IP address ranges  	    |
...
**[Traffic Chart](/docs/guide/ug/cg/retrotools#show-traffic-chart-for-an-item)**  
