...
| 7   | [Real Time Traffic](/docs/guide/ug/ui/module_templates#real-time-traffic)       |
| 8   | [Real Time Single](/docs/guide/ug/ui/module_templates#real-time-single)         |
| 9   | [Real Time Toppers](/docs/guide/ug/ui/module_templates#real-time-toppers)       |
| 10  | [Favorite Key Traffic](/docs/guide/ug/ui/module_templates#favorite-key-traffic) |
| 11  | [Traffic Chart](/docs/guide/ug/ui/module_templates#traffic-chart)               |
| 12  | [Alert List](/docs/guide/ug/ui/module_templates#alert-list)                     |
| 13  | [Alert Count](/docs/guide/ug/ui/module_templates#alert-count)                   |
| 14  | [Existing Modules](/docs/guide/ug/ui/module_templates#existing-modules)         |
| 15  | [Custom URL Page](/docs/guide/ug/ui/module_templates#custom-url-page)           |
| 16  | [Crosskey Tree](/docs/guide/ug/ui/module_templates#crosskey-tree)               |
| 17  | [Crosskey Sankey](/docs/guide/ug/ui/module_templates#crosskey-sankey)       
...
| Expression     | -             | Use an [arithmetic expression](/docs/guide/ug/ui/modules#creating-modules-with-arithmetic-expressions) to customize the data shown by the module.    |
...
| Enable Range Slider            | -             | Enables a [range slider](/docs/guide/ug/ui/charts#range-slider), so users can select a specific portion of the displayed time range.                                            |
| Mark PCAP Availability         | -             | Displays [availability of PCAP (Packet Capture) data](/docs/guide/ug/ui/charts#pcap-availability), on the chart when packet capture data is available.                        |
| Show Retro Tabs/ Time Selector | -             | Toggle to display or hide [retro tabs](/docs/guide/ug/ui/charts#retro-tabs) and [time selector](/docs/guide/ug/ui/elements#time-selector), allowing users to navigate through historical data                                                                                                  | 
