...
> **Before you begin:** If you are new to Trisul dashboards and modules, see [Introduction to Dashboards and Modules](/docs/guide/ug/ui/dashmod_intro) to understand how dashboards and modules work together.
...
To edit a Dashboard, from the list of dashboards go to the dashboard you would like to edit. And click on the [Dashboard Menu](/docs/guide/ug/ui/create_dashboards#dashboard-menu-options) button, the **ellipsis icon** on the top right corner of the dashboard and click **Customize**.
