...
- **Hover**: Display additional information or context on [Tooltips](/docs/guide/ug/ui/charts#tooltip) when hovering over a data point  
...
1) [Ellipsis Menu](/docs/guide/ug/ui/charts#ellipsis-menu)
2) [Chart Interaction Control Icons](/docs/guide/ug/ui/charts#chart-interaction-controls)
3) [Tool Tip](/docs/guide/ug/ui/charts#tooltip) 
4) [Legend Table](/docs/guide/ug/ui/charts#legend-table)

### 1) Ellipsis Menu {#ellipsis-menu}
...
### 2) Chart Interaction Controls {#chart-interaction-controls}
...
1) Click on the [*ellipsis menu*](/docs/guide/ug/ui/charts#ellipsis-menu) from any chart and click *View historical* to view the retro chart of that particular module

![](images/retrochart2.png)

*Figure: View Historical Option from Module Toolbar*

2) Select a [time frame](/docs/guide/ug/ui/elements#time-selector) and view the retro chart for that particular past time period.
...
The time-based tabs include:
  ...
  **Custom** Tab: Redirects users to the [Time Selector](/docs/guide/ug/ui/elements#time-selector), allowing for flexible, user-defined time ranges and custom data segmentation.
