...
From the list of module types select one and fill out the fields according to the [module template](/docs/guide/ug/ui/module_templates) you have selected.

### Add Modules to a New/Existing Dashboard

To add modules to an empty dashboard, Create a [New Dashboard](/docs/guide/ug/ui/create_dashboards#add-modules-to-a-dashboard) by clicking **New** in the All dashboards page. 
...
:point_right: Click Customize on the [Ellipsis Menu](/docs/guide/ug/ui/charts#ellipsis-menu) from the dashboard that contains the module.
...
Alternatively you can also edit it from the list of [all modules](/docs/guide/ug/ui/dashmod_intro#viewing-modules), Click on the three lines on the right side against the module you would like to edit and click Edit.

Clicking on Customize will take you to customization options based on the type of module selected. To see the parameters for different types of modules, check here: [Module Templates](/docs/guide/ug/ui/module_templates)

### How to Clone/Delete a Module from the Dashboard

If you have observed a module that you would like to add as a new module, you can Clone a similar module to create new module. For that, Go to the list of [all modules](/docs/guide/ug/ui/dashmod_intro#viewing-modules),and from the list of available modules, Click on the three lines on the right side against the module. Now click Clone and edit the required fields.
