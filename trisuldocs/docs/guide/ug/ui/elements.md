...
The search box is located on the right side of the [Top Panel](/docs/guide/ug/ui/userlayout#top-panel-details) as shown here.
...
You can click on any key items on the chart and it will take you to the [Key dashboard](/docs/guide/ug/ui/key_dashboard) of that Key.
