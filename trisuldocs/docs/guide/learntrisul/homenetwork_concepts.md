...
This final set is used by Trisul in the NetFlow configuration file in the [HomeASNumbers](pathname:///docs/guide/ref/netflow-config#HomeASNumbers) parameter using a periodic update mechanism.
