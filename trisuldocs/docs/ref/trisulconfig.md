...
| MaxTCARangeAlerts        | 100      | When usingTCArange alerts (see[TCA](/docs/ug/alerts/tca#configuring)generate only these many alerts. The reason we need a safety cap on this feature is an incorrect configuration with aTCArange can result in uncontrolled alerts (eg when any IP crosses 1Kbps). For safety we have chosen a cap or 100                                                                                                                                                                                                                                                                                                                                                                          |
