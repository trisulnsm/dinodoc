...
IPDR sizing is based on the ISP's peak throughput rate which is the sum of uplinks and peering peak bandwidth usage. This translates into NetFlow/IPFIX rate.
...
For large ISP who want to setup a POC system with a few gateways and/or AAA integrated we recommend the following minimum configuration
...
| Memory |  16GB RAM |
| Network | 1GbE interface that can be used for both NetFlow and Management access |
| Disk | 1TB for a few days of storage  |
| OS | Ubuntu 24.04 or RHEL 9|

Please contact Unleash Networks for a POC.
