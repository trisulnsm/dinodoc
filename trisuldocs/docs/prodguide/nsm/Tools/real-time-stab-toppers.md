...
Sliding-window topper detection identifying sudden traffic bursts and top consumers.

## Overview

In the Trisul NSM Web UI, **Real Time Stab Toppers** is located under the **Tools** menu.

:::info Navigation
:point_right: Go to **Tools &rarr; Real Time Stab Toppers**
:::

## Key Features

- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to real time stab toppers.
...
1. Navigate to **Tools &rarr; Real Time Stab Toppers** from the left-hand navigation panel.
