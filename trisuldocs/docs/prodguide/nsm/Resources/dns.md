...
As shown in the figure, each question in the [*search results*](/docs/prodguide/nsm/Resources/dns#search-results) has a corresponding answer in the form of a resolved IP address.
