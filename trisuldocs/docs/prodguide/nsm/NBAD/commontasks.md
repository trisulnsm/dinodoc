...
Navigate to **NBAD → Flow Map**. Adjust the **Time window** to your investigation period. Review **Top Countries Uploaded to** and **Top Countries Downloaded from** panels. Unusual countries in the top list warrant flow-level investigation via [Explore Flows](/docs/guide/ug/tools/explore_flows).
