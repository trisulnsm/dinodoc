...
- **[Performing Retro Analysis](/docs/guide/ug/cg/retro)** — Learn how to select a historical time period and start a retro analysis.
- **[Retro Analysis Tools](/docs/guide/ug/cg/retrotools)** — See the available tools for investigating historical network activity.
- **[Retro Q&A](/docs/guide/ug/cg/retrofaq)** — Use predefined questions to perform common retro investigations.
