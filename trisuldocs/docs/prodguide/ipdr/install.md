...
- Get a VM or a physical server ready for IPDR. See [System Requirements](/docs/prodguide/ipdr/requirements)
...
:memo: Follow the steps in  [Installation section in the Trisul User Guide](/docs/guide/starthere/setuptrisul/install/doinstall) 
...
See : [How to re-enable product mode selector](/docs/guide/starthere/setuptrisul/install/selectmode#re-enabling-product-mode-selector)