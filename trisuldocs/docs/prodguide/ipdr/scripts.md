...
| Programs |  |
| ------| ---|
| [trisul-ipdr](/docs/prodguide/ipdr/scripts#trisul-ipdr-service) | The `trisul-ipdr` service is responsible for executing requests |
| [tool_qstreamflow](/docs/prodguide/ipdr/scripts#tool_qstreamflow) | The program that actually queries and builds the IPDR response |
| [trisul_aaaing](/docs/prodguide/ipdr/trisul_aaaing) | The RADIUS AAA log ingestor. Usually run in cron |
