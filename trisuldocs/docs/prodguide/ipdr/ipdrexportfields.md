...
Completed queries allow you to download the results in [three document formats](/docs/prodguide/ipdr/ipdrui#download).
...
agent can directly download the results by pressing the [Download button](/docs/prodguide/ipdr/ipdrui#download). See [IPDR Settings > Download File Size](ipdr-settings) to adjust this limit.
