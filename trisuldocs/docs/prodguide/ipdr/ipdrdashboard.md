...
The header of the module contains the total number of status of queries [**Started/Completed/Cancelled**](/docs/prodguide/ipdr/ipdrui#query-summary) by the user.
