...
- The [Storage Status](/docs/guide/ag/admintasks/storage_status)  tool can be used to find out the slices for any day
...
Edit the [Trisul Hub Configuration file](/docs/guide/ref/trisulhubconfig#advanced-archiving) and set the `OfflineArchiveTag` to `tape` 
...
Now you can run the IPDR Query with the date Feb 10, 2025 as described in [Submit Queries](/docs/prodguide/ipdr/submit-queries)
