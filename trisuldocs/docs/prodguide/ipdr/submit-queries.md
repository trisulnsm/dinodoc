...
As a safety mechanism, the Full Database Dump is capped to 250,000 records.  This is controlled by the [IPDR > MaxRecords](/docs/guide/ref/trisulhubconfig#ipdr) option in the Trisul Hub Configuration file. 


### User Name

To add User ID from [customer inventory database](/docs/prodguide/ipdr/staticip-mappings) to flows. 

Go to [Trisul Apps](/docs/guide/ag/webadmin/apps) and download and install **IPDR Tagger** app to enable tagging of group of IPs to a user ID. 
