...
1) [How to ensure email, notification, and alert delivery are working correctly?](/docs/guide/ug/alerts/email_wizard)
2) [How to ensure the **Watchdog** service is actively monitoring your system?](/docs/guide/programs/runhubflusher_watchdog)
3) How to ensure overall System Health is verified:   
[(a) Manual Check](/docs/guide/ag/admintasks/system_health)  
[(b) Get daily System Health Report delivered to your Email](/docs/guide/ug/reports/schedreports)
4) [How to ensure two-year IPDR log retention is properly setup?](/docs/guide/ag/basictasks/configure_storage#retention-period-on-the-hub)
