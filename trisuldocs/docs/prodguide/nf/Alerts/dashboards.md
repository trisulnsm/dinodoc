...
Dedicated alerts dashboard visualizing active alerts, severity breakdown, and alert trends.

## Overview

In the Trisul NetFlow Analyzer Web UI, **Dashboards** is located under the **Alerts** menu.

:::info Navigation
:point_right: Go to **Alerts &rarr; Dashboards**
:::

## Key Features

- **Traffic Observability**: Provides deep flow-level metrics and visibility relevant to dashboards.
...
1. Navigate to **Alerts &rarr; Dashboards** from the left-hand navigation panel.
