...
* **Connections:** which hosts are communicating most frequently
* **Activity:** whether network activity is increasing or changing unexpectedly

Think of it as a **starting point for network investigation**. You spot something interesting here, then drill into it using the detailed views in Trisul.
