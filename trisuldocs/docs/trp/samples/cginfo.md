...
See[here for a list of common GUIDs](/docs/documentation/ref/guid.md). You can also go to // Customize > Counters > Meters // to get the GUIDs of all counter groups running on your system.
