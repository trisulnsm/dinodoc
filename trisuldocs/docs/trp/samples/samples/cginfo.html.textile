h1. Print counter group information 
...
The only difference between the two is for the former we have to specify a _:counter_group_ guid parameter. For the latter, we leave it blank forcing Trisul to retrieve all the counter group information.

See "here for a list of common GUIDs":/docs/ref/guid.html. You can also go to // Customize > Counters > Meters // to get the GUIDs of all counter groups running on your system.
