...
All these samples are written in Ruby, and use the "trisulrp"://rubygems.org/gems/trisulrp gem. These scripts can be easily adapted to other languages like Python or Java.

p(autohint github success ). 
We have a new Github repo called "trisul-samples":https://github.com/trisulnsm/trisul-scripts  containing all our scripts. 

|_.Name|_.Description|
|"flows_for_ip":samples/flows_for_ip.html|Print top 100 flows for an IP or host during the past 6 hours.This script contains detailed line by line comments, so start here |
