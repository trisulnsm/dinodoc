  ...
  docsSidebar: [
    {
      ...
      items: [
        /* Introduction */
        {
          ...
          items: ['ug/intro/getstart', 'ug/intro/terminology'],
        }, /* end Introduction */
        ...
        'ipdr/intro',
        {
          ...
          items: [
            ...
            'ipdr/specialuser',
            {
              type: 'category',
              label: 'Settings',
              items: ['ipdr/ipdr-settings', 'ipdr/advanced'],
            },
          ],
        },
        {
          ...
          items: ['ipdr/netflow', 'ipdr/radius', 'ipdr/syslog'],
        },
        {
          type: 'category',
          label: 'Programs and Scripts',
          link: { type: 'doc', id: 'ipdr/scripts' },
          items: ['ipdr/trisul_aaaing', 'ipdr/qstream'],
        },
        'ipdr/ipdrui',
        'ipdr/submit-queries',
        'ipdr/ipdrdashboard',
