  ...
  startHereSidebar: [
    {
      ...
      collapsed: false,
      items: [
        'ug/intro/architecture',
        'ug/intro/dataflow',
        'ug/intro/productmodes',
      ],
    },
  ],
  ...
  learnTrisulSidebar: [
    {
      ...
      link: {
        type: 'doc',
        id: 'learntrisul/terminology',
      },
      className: 'root-section-title',
      collapsible: false,
      collapsed: false,
      items: [
        'learntrisul/terminology',
        'learntrisul/homenetwork_concepts',
        {
          type: 'category',
          label: 'Flow Concepts',
          link: { type: 'doc', id: 'learntrisul/flow_concepts/index' },
          items: [
            'learntrisul/flow_concepts/deduplication',
          ],
        },
        {
          type: 'category',
          label: 'Trisul Domain Concepts',
          link: { type: 'doc', id: 'learntrisul/concepts/index' },
          items: [
            {
              type: 'autogenerated',
              dirName: 'learntrisul/concepts',
            },
          ],
        },
      ],
  ...
  setupTrisulSidebar: [
    {
      ...
      link: {
        type: 'doc',
        id: 'setuptrisul/install/requirements',
      },
      className: 'root-section-title',
      collapsible: false,
      collapsed: false,
      items: [
        'setuptrisul/install/requirements',
        {
          type: 'category',
          label: 'Installation',
          link: { type: 'doc', id: 'setuptrisul/install/index' },
          items: [
            {
              type: 'category',
              label: 'Packages',
              link: { type: 'doc', id: 'setuptrisul/install/packages' },
              items: ['setuptrisul/install/badfellas', 'setuptrisul/install/geoasn'],
            },
            'setuptrisul/install/pkgverify',
            'setuptrisul/install/doinstall',
            'setuptrisul/install/selectmode',
            'setuptrisul/install/trisulaicli',
            'setuptrisul/install/doupgrade',
            'setuptrisul/install/douninstall',
            'setuptrisul/install/openports',
          ],
        },
        {
          type: 'category',
          label: 'Licensing',
          link: { type: 'doc', id: 'setuptrisul/license/index' },
          items: [
            'setuptrisul/license/intro',
            'setuptrisul/license/install',
          ],
        },
        {
          type: 'category',
          label: 'Configure the Network',
          link: { type: 'doc', id: 'setuptrisul/network/index' },
          items: [
            'setuptrisul/network/input_packets',
            'setuptrisul/network/input_netflow',
          ],
        },
        {
          type: 'category',
          label: 'First Login',
          link: { type: 'doc', id: 'setuptrisul/login' },
          items: [
            'setuptrisul/login',
          ]
        }
